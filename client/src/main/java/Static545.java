...
public final class Static545 {
	...
	public static void remove(@OriginalArg(1) String arg0) {
		...
		for (@Pc(22) int local22 = 0; local22 < Static327.size; local22++) {
			...
			if (Static585.method7682(arg0, local31, local27, local11)) {
				Static327.size--;
				for (@Pc(44) int local44 = local22; local44 < Static327.size; local44++) {
					...
					Static371.worlds[local44] = Static371.worlds[local44 + 1];
					Static419.worldNames[local44] = Static419.worldNames[local44 + 1];
					Static715.ranks[local44] = Static715.ranks[local44 + 1];
