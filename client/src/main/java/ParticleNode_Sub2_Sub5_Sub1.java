...
public final class ParticleNode_Sub2_Sub5_Sub1 extends ParticleNode_Sub2_Sub5 {
	...
	public ParticleNode_Sub2_Sub5_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
	...
	public int method9287() {
		@Pc(9) ObjType local9 = ObjTypeList.objTypes.method2486(this.anInt8867);
		@Pc(12) int local12 = local9.anInt10138;
		if (this.anInt8878 != -1) {
			@Pc(22) ObjType local22 = ObjTypeList.objTypes.method2486(this.anInt8878);
			if (local22.anInt10138 > local12) {
				local12 = local22.anInt10138;
			}
		}
		if (this.anInt8876 != -1) {
			@Pc(48) ObjType local48 = ObjTypeList.objTypes.method2486(this.anInt8876);
	...
	public boolean method9279(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Class19 arg3) {
		...
		if (this.anInt8878 != -1) {
			local82 = ObjTypeList.objTypes.method2486(this.anInt8878);
		...
		if (this.anInt8876 != -1) {
			local82 = ObjTypeList.objTypes.method2486(this.anInt8876);
	...
	public ParticleNode_Sub7 method9276(@OriginalArg(1) Class19 arg0) {
		...
		if (this.anInt8876 != -1) {
			local369 = ObjTypeList.objTypes.method2486(this.anInt8876).method8805((Class152) null, 2048, (PlayerAppearance) null, this.anInt8872, arg0);
			if (local369 != null) {
		...
		if (this.anInt8878 != -1) {
			local369 = ObjTypeList.objTypes.method2486(this.anInt8878).method8805((Class152) null, 2048, (PlayerAppearance) null, this.anInt8874, arg0);
			if (local369 != null) {
				if (Static504.aBoolean579) {
		...
		local369 = ObjTypeList.objTypes.method2486(this.anInt8867).method8805((Class152) null, 2048, (PlayerAppearance) null, this.anInt8873, arg0);
		if (local369 != null) {
			if (Static504.aBoolean579) {
