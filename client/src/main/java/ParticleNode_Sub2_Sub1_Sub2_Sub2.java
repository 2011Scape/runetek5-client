...
public final class ParticleNode_Sub2_Sub1_Sub2_Sub2 extends ParticleNode_Sub2_Sub1_Sub2 {
	...
	public ParticleNode_Sub2_Sub1_Sub2_Sub2() {
	}

	@OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(I)V")
	public ParticleNode_Sub2_Sub1_Sub2_Sub2(@OriginalArg(0) int arg0) {
		super(arg0);
	}
