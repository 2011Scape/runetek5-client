...
public final class QuickChatPhraseType extends SecondaryLinkable {

	@OriginalMember(owner = "client!ih", name = "A", descriptor = "[[I")
	private int[][] anIntArrayArray101;

	@OriginalMember(owner = "client!ih", name = "v", descriptor = "Lclient!gba;")
	public QuickChatPhraseTypeList aQuickChatPhraseTypeList1;
	...
	public String method3903(@OriginalArg(1) Packet arg0) {
		...
		if (this.anIntArray331 != null) {
			for (@Pc(15) int local15 = 0; local15 < this.anIntArray331.length; local15++) {
				...
				local10.append(this.aQuickChatPhraseTypeList1.method2948(this.method3898(local15), arg0.gVarLong(Static446.method6091(this.anIntArray331[local15]).anInt4577), this.anIntArrayArray101[local15]));
			}
		}
