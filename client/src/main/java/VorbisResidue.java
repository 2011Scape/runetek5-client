...
public final class VorbisResidue {
	...
	public void method5122(@OriginalArg(0) float[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2) {
		...
		@Pc(19) int local19 = Static650.aVorbisCodebookArray1[this.anInt5701].anInt6803;
		...
		for (@Pc(35) int local35 = 0; local35 < 8; local35++) {
			...
			while (local38 < local30) {
				...
				@Pc(51) int local51;
				if (local35 == 0) {
					local47 = Static650.aVorbisCodebookArray1[this.anInt5701].method6111();
				...
				for (local47 = 0; local47 < local19; local47++) {
					...
					if (local90 >= 0) {
						...
						@Pc(104) VorbisCodebook local104 = Static650.aVorbisCodebookArray1[local90];
						@Pc(113) int local113;
						if (this.anInt5703 == 0) {
