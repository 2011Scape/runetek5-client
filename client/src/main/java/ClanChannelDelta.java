...
public final class ClanChannelDelta {
	...
	public ClanChannelDelta(@OriginalArg(0) Packet arg0) {
	...
	private void method1580(@OriginalArg(0) Packet arg0) {
		...
		for (@Pc(21) int local21 = arg0.g1(); local21 != 0; local21 = arg0.g1()) {
			@Pc(44) ClanChannelDeltaType local44;
			if (local21 == 1) {
				local44 = new ClanChannelDeltaType1();
			} else if (local21 == 4) {
				local44 = new ClanChannelDeltaType4();
			} else if (local21 == 3) {
				local44 = new ClanChannelDeltaType3();
			} else if (local21 == 2) {
				local44 = new ClanChannelDeltaType2();
			} else {
	...
	public void method1581(@OriginalArg(0) ClanChannel arg0) {
		...
		for (@Pc(69) ClanChannelDeltaType local69 = (ClanChannelDeltaType) this.aLinkedList10.head(); local69 != null; local69 = (ClanChannelDeltaType) this.aLinkedList10.next()) {
