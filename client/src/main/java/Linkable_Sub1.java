...
public abstract class Linkable_Sub1 extends Linkable {
	...
	public final Linkable_Sub1[] aClass2_Sub1Array42;

	@OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(IZ)V")
	protected Linkable_Sub1(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
		this.aBoolean824 = arg1;
		this.aClass2_Sub1Array42 = new Linkable_Sub1[arg0];
	}
