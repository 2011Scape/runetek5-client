...
public final class NpcType {
	...
	public NpcTypeList aNpcTypeList1;
	...
	public boolean method5984() {
		...
		for (@Pc(35) int local35 = 0; local35 < this.anIntArray532.length; local35++) {
			if (this.anIntArray532[local35] != -1) {
				@Pc(62) NpcType local62 = this.aNpcTypeList1.method7092(this.anIntArray532[local35]);
	...
	public NpcType method5985(@OriginalArg(0) int arg0, @OriginalArg(1) VarDomain arg1) {
		...
		if (local11 < 0 || this.anIntArray532.length - 1 <= local11 || this.anIntArray532[local11] == -1) {
			...
			return local66 == -1 ? null : this.aNpcTypeList1.method7092(local66);
		} else {
			return this.aNpcTypeList1.method7092(this.anIntArray532[local11]);
		}
	}
	...
	private void method5990(@OriginalArg(0) int arg0, @OriginalArg(1) Packet arg1) {
		@Pc(12) int local12;
		@Pc(18) int local18;
		if (arg0 == 1) {
			local12 = arg1.g1();
			...
			if (arg0 == 106 || arg0 == 118) {
				...
				if (!this.aNpcTypeList1.aBoolean621) {
	...
	public Model method5992(@OriginalArg(1) Class152 arg0, @OriginalArg(2) Class386 arg1, @OriginalArg(4) Class19 arg2, @OriginalArg(5) VarDomain arg3) {
		if (this.anIntArray532 != null) {
			...
			if (local94 == null || (local94.ua() & local54) != local54) {
				...
				@Pc(219) Js5 local219 = this.aNpcTypeList1.aJs5102;
				synchronized (this.aNpcTypeList1.aJs5102) {
					...
					while (true) {
						...
						local215[local223] = Static121.method2201(local163[local223], this.aNpcTypeList1.aJs5102);
						local223++;
					}
				}
				...
				local94 = arg2.method7952(local304, local125, this.aNpcTypeList1.anInt8088, 64, 768);
				@Pc(340) int local340;
		...
		if (local139 == null || local32 != (local139.ua() & local32)) {
			...
			for (local226 = 0; local226 < local216.length; local226++) {
				if (local216[local226] != -1) {
					@Pc(280) Js5 local280 = this.aNpcTypeList1.aJs5102;
					synchronized (this.aNpcTypeList1.aJs5102) {
						local267[local226] = Static121.method2201(local216[local226], this.aNpcTypeList1.aJs5102);
					}
			...
			local139 = arg1.method7952(local529, local178, this.aNpcTypeList1.anInt8088, this.anInt6732 + 64, this.anInt6747 + 850);
