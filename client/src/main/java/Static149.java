...
public final class Static149 {
	...
	public static void method2449(@OriginalArg(0) Class19 arg0) {
		...
		@Pc(89) int local89;
		@Pc(202) int local202;
		@Pc(281) SecondaryLinkable_Sub16 local281;
		@Pc(190) SecondaryLinkable_Sub16 local190;
		if (Static236.aBoolean304) {
			local70 = 0;
			for (local77 = (SecondaryLinkable_Sub4) Static350.aSecondaryLinkedList8.head(); local77 != null; local77 = (SecondaryLinkable_Sub4) Static350.aSecondaryLinkedList8.next()) {
				local89 = local23 + local70 * 16 + 13 + 20;
				if (local55 > local5 + Static71.anInt1576 && local55 < local5 + Static71.anInt1576 + Static682.anInt10295 && local66 > local89 - 13 && local66 < local89 + 4 && (local77.anInt1534 > 1 || ((SecondaryLinkable_Sub16) local77.aSecondaryLinkedList3.sentinel.secondaryPrev).aBoolean552)) {
			...
			if (Static139.aClass2_Sub2_Sub4_1 != null) {
				...
				local70 = 0;
				for (local190 = (SecondaryLinkable_Sub16) Static139.aClass2_Sub2_Sub4_1.aSecondaryLinkedList3.head(); local190 != null; local190 = (SecondaryLinkable_Sub16) Static139.aClass2_Sub2_Sub4_1.aSecondaryLinkedList3.next()) {
			...
			local70 = 0;
			for (local281 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.head(); local281 != null; local281 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.next()) {
		...
		if (Static236.aBoolean304) {
			...
			for (local77 = (SecondaryLinkable_Sub4) Static350.aSecondaryLinkedList8.head(); local77 != null; local77 = (SecondaryLinkable_Sub4) Static350.aSecondaryLinkedList8.next()) {
				...
				if (local77.anInt1534 == 1) {
					Static232.method3387(arg0, Static682.anInt10295, Static407.anInt6288, Static84.anInt1775 + local7, local89, Static634.anInt9510 | 0xFF000000, (SecondaryLinkable_Sub16) local77.aSecondaryLinkedList3.sentinel.secondaryPrev, Static563.anInt8455 | 0xFF000000, local66, Static71.anInt1576 + local5, local55);
				} else {
