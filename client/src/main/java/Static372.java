...
public final class Static372 {
	...
	public static int method5291(@OriginalArg(0) boolean arg0) {
		if (Static552.anIntArray753 == null) {
			...
			for (@Pc(31) int local31 = 0; local31 < Static552.anIntArray753.length; local31++) {
				...
				if (Static555.aJs5106.isFileReady(local36)) {
					local29++;
				}
				if (Static237.aJs587.isFileReady(local36)) {
					local29++;
				}
			}
			return local29;
	...
	public static int method5292(@OriginalArg(0) int arg0, @OriginalArg(1) Component arg1) {
		if (!Static84.getServerActiveProperties(arg1).isButtonEnabled(arg0) && arg1.onOptionClick == null) {
			return -1;
