...
public final class Model_Sub1 extends Model {
		...
		if (arg0 == 0) {
			...
			if (arg0 == 2) {
				for (local16 = 0; local16 < this.anInt2773; local16++) {
					...
					if (arg3 != 0) {
						local20 = Model.anIntArray741[arg3];
						local180 = Model.anIntArray740[arg3];
					...
					if (arg1 != 0) {
						local20 = Model.anIntArray741[arg1];
						local180 = Model.anIntArray740[arg1];
					...
					if (arg2 != 0) {
						local20 = Model.anIntArray741[arg2];
						local180 = Model.anIntArray740[arg2];
	...
	public void VA(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = Model.anIntArray741[arg0];
		@Pc(13) int local13 = Model.anIntArray740[arg0];
				...
				if (local32 < this.anIntArrayArray66.length) {
					...
					if ((arg5 & 0x1) == 0) {
						for (local164 = 0; local164 < local162.length; local164++) {
							...
							if (arg4 != 0) {
								local62 = Model.anIntArray741[arg4];
								local287 = Model.anIntArray740[arg4];
							...
							if (arg2 != 0) {
								local62 = Model.anIntArray741[arg2];
								local287 = Model.anIntArray740[arg2];
							...
							if (arg3 != 0) {
								local62 = Model.anIntArray741[arg3];
								local287 = Model.anIntArray740[arg3];
					...
					if (local40 < this.anIntArrayArray66.length) {
						...
						for (local56 = 0; local56 < local54.length; local56++) {
							...
							for (local774 = local287; local774 < local306; local774++) {
								...
								@Pc(821) int local821;
								if (arg4 != 0) {
									local798 = Model.anIntArray741[arg4];
									local802 = Model.anIntArray740[arg4];
								...
								if (arg2 != 0) {
									local798 = Model.anIntArray741[arg2];
									local802 = Model.anIntArray740[arg2];
								...
								if (arg3 != 0) {
									local798 = Model.anIntArray741[arg3];
									local802 = Model.anIntArray740[arg3];
	...
	protected void I(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int[] arg7) {
		...
		if (arg0 == 2) {
			if (arg7 == null) {
					...
					if (this.anIntArrayArray66.length > local32) {
						...
						for (local258 = 0; local258 < local256.length; local258++) {
							...
							if (this.aShortArray41 == null || (arg6 & this.aShortArray41[local52]) != 0) {
								...
								if (arg4 != 0) {
									local58 = Model.anIntArray741[arg4];
									local393 = Model.anIntArray740[arg4];
								...
								if (arg2 != 0) {
									local58 = Model.anIntArray741[arg2];
									local393 = Model.anIntArray740[arg2];
								...
								if (arg3 != 0) {
									local58 = Model.anIntArray741[arg3];
									local393 = Model.anIntArray740[arg3];
							...
							for (local52 = 0; local52 < local50.length; local52++) {
								...
								if (this.aShortArray41 == null || (arg6 & this.aShortArray41[local58]) != 0) {
									...
									for (local437 = local393; local437 < local415; local437++) {
										...
										if (arg4 != 0) {
											local476 = Model.anIntArray741[arg4];
											local480 = Model.anIntArray740[arg4];
										...
										if (arg2 != 0) {
											local476 = Model.anIntArray741[arg2];
											local480 = Model.anIntArray740[arg2];
										...
										if (arg3 != 0) {
											local476 = Model.anIntArray741[arg3];
											local480 = Model.anIntArray740[arg3];
				...
				local415 = Model.anIntArray740[arg2];
				local437 = Model.anIntArray741[arg2];
				local472 = Model.anIntArray740[arg3];
				local476 = Model.anIntArray741[arg3];
				local480 = Model.anIntArray740[arg4];
				local484 = Model.anIntArray741[arg4];
