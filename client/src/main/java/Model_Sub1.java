...
public final class Model_Sub1 extends Model {
	...
	public Model_Sub1(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class88 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		for (@Pc(24) int local24 = 0; local24 < arg1.anInt2362; local24++) {
			if (arg1.aByteArray25 == null || arg1.aByteArray25[local24] != 2) {
				if (arg1.aShortArray25 != null && arg1.aShortArray25[local24] != -1) {
					@Pc(65) Material local65 = local11.method6817(arg1.aShortArray25[local24] & 0xFFFF);
				...
				for (local184 = 0; local184 < arg1.aClass24Array1.length; local184++) {
					...
					if (local191.anInt588 == local167) {
						...
						if (local204.anInt9693 != -1) {
							@Pc(220) Material local220 = local11.method6817(local204.anInt9693);
		...
		for (local184 = 0; local184 < this.anInt2715; local184++) {
			...
			if (local1164 != -1 && (this.anInt2765 & 0x40) != 0) {
				@Pc(1181) Material local1181 = local11.method6817(local1164 & 0xFFFF);
		...
		if (arg0 == 0) {
			...
			if (arg0 == 2) {
				for (local16 = 0; local16 < this.anInt2773; local16++) {
					...
					if (arg3 != 0) {
						local20 = LruHashTable.anIntArray741[arg3];
						local180 = LruHashTable.anIntArray740[arg3];
					...
					if (arg1 != 0) {
						local20 = LruHashTable.anIntArray741[arg1];
						local180 = LruHashTable.anIntArray740[arg1];
					...
					if (arg2 != 0) {
						local20 = LruHashTable.anIntArray741[arg2];
						local180 = LruHashTable.anIntArray740[arg2];
	...
	public void VA(@OriginalArg(0) int arg0) {
		@Pc(9) int local9 = LruHashTable.anIntArray741[arg0];
		@Pc(13) int local13 = LruHashTable.anIntArray740[arg0];
				...
				if (local32 < this.anIntArrayArray66.length) {
					...
					if ((arg5 & 0x1) == 0) {
						for (local164 = 0; local164 < local162.length; local164++) {
							...
							if (arg4 != 0) {
								local62 = LruHashTable.anIntArray741[arg4];
								local287 = LruHashTable.anIntArray740[arg4];
							...
							if (arg2 != 0) {
								local62 = LruHashTable.anIntArray741[arg2];
								local287 = LruHashTable.anIntArray740[arg2];
							...
							if (arg3 != 0) {
								local62 = LruHashTable.anIntArray741[arg3];
								local287 = LruHashTable.anIntArray740[arg3];
					...
					if (local40 < this.anIntArrayArray66.length) {
						...
						for (local56 = 0; local56 < local54.length; local56++) {
							...
							for (local774 = local287; local774 < local306; local774++) {
								...
								@Pc(821) int local821;
								if (arg4 != 0) {
									local798 = LruHashTable.anIntArray741[arg4];
									local802 = LruHashTable.anIntArray740[arg4];
								...
								if (arg2 != 0) {
									local798 = LruHashTable.anIntArray741[arg2];
									local802 = LruHashTable.anIntArray740[arg2];
								...
								if (arg3 != 0) {
									local798 = LruHashTable.anIntArray741[arg3];
									local802 = LruHashTable.anIntArray740[arg3];
	...
	protected void I(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int[] arg7) {
		...
		if (arg0 == 2) {
			if (arg7 == null) {
					...
					if (this.anIntArrayArray66.length > local32) {
						...
						for (local258 = 0; local258 < local256.length; local258++) {
							...
							if (this.aShortArray41 == null || (arg6 & this.aShortArray41[local52]) != 0) {
								...
								if (arg4 != 0) {
									local58 = LruHashTable.anIntArray741[arg4];
									local393 = LruHashTable.anIntArray740[arg4];
								...
								if (arg2 != 0) {
									local58 = LruHashTable.anIntArray741[arg2];
									local393 = LruHashTable.anIntArray740[arg2];
								...
								if (arg3 != 0) {
									local58 = LruHashTable.anIntArray741[arg3];
									local393 = LruHashTable.anIntArray740[arg3];
							...
							for (local52 = 0; local52 < local50.length; local52++) {
								...
								if (this.aShortArray41 == null || (arg6 & this.aShortArray41[local58]) != 0) {
									...
									for (local437 = local393; local437 < local415; local437++) {
										...
										if (arg4 != 0) {
											local476 = LruHashTable.anIntArray741[arg4];
											local480 = LruHashTable.anIntArray740[arg4];
										...
										if (arg2 != 0) {
											local476 = LruHashTable.anIntArray741[arg2];
											local480 = LruHashTable.anIntArray740[arg2];
										...
										if (arg3 != 0) {
											local476 = LruHashTable.anIntArray741[arg3];
											local480 = LruHashTable.anIntArray740[arg3];
				...
				local415 = LruHashTable.anIntArray740[arg2];
				local437 = LruHashTable.anIntArray741[arg2];
				local472 = LruHashTable.anIntArray740[arg3];
				local476 = LruHashTable.anIntArray741[arg3];
				local480 = LruHashTable.anIntArray740[arg4];
				local484 = LruHashTable.anIntArray741[arg4];
	...
	private Model method2557(@OriginalArg(0) int arg0, @OriginalArg(1) Model_Sub1 arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) Model_Sub1 arg4) {
	...
	public void aa(@OriginalArg(0) short arg0, @OriginalArg(1) short arg1) {
		...
		if (arg1 != -1) {
			@Pc(74) Material local74 = local9.method6817(arg1 & 0xFFFF);
	...
	public SecondaryLinkable_Sub9 ba(@OriginalArg(0) SecondaryLinkable_Sub9 arg0) {
		...
		@Pc(187) SecondaryLinkable_Sub9_Sub1 local187 = (SecondaryLinkable_Sub9_Sub1) arg0;
		@Pc(199) SecondaryLinkable_Sub9_Sub1 local199;
		if (local187 != null && local187.method2192(local177, local184)) {
			local199 = local187;
			local187.method2196();
		} else {
			local199 = new SecondaryLinkable_Sub9_Sub1(this.aClass19_Sub1_6, local177, local184);
		}
	...
	private void method2565(@OriginalArg(1) SecondaryLinkable_Sub9_Sub1 arg0) {
