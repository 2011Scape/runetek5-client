...
public final class Linkable_Sub8 extends Linkable {

	@OriginalMember(owner = "client!bn", name = "l", descriptor = "Lclient!av;")
	public HashTable aHashTable8;
	...
	public Linkable_Sub8(@OriginalArg(0) Packet arg0) {
	...
	public void method1154() {
		if (this.aHashTable8 != null) {
			return;
		}
		this.aHashTable8 = new HashTable(16);
				...
				while (local30.anIntArray70[local52] == local57) {
					...
					if (local84 == 144) {
						...
						if (local103 > 0) {
							...
							@Pc(190) Linkable_Sub55 local190 = (Linkable_Sub55) this.aHashTable8.get((long) local182);
							if (local190 == null) {
								local190 = new Linkable_Sub55(new byte[128]);
								this.aHashTable8.put((long) local182, local190);
							}
