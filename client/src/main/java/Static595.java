	...
	public static void method7807(@OriginalArg(1) String arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2) {
		...
		if (arg2 == 0) {
			...
			if (arg0 != null) {
				...
				@Pc(45) Class14 local45 = Static163.aClass19_17.method8010(local36, Static735.method9375(Static721.aJs5128, Static539.anInt8173), true);
			...
			if (arg0 != null) {
				local57 = Static255.method3612(Static124.aJs520, Static56.anInterface4_3, 0, Static434.aCanvas7, 0);
				local57.GA(0);
				@Pc(76) Class381 local76 = Static74.method1535(Static539.anInt8173, Static697.aJs5123);
				local85 = local57.method8010(local76, Static735.method9375(Static721.aJs5128, Static539.anInt8173), true);
				Static288.method4182();
			...
			label216: {
				try {
					...
					if (arg0 != null) {
						...
						@Pc(127) Class14 local127 = local57.method8010(local118, Static735.method9375(Static721.aJs5128, Static539.anInt8173), true);
						Static288.method4182();
