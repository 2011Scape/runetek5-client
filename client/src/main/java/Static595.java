	...
	public static void method7807(@OriginalArg(1) String arg0, @OriginalArg(2) boolean arg1, @OriginalArg(3) int arg2) {
		...
		if (arg2 == 0) {
			...
			if (arg0 != null) {
				...
				@Pc(45) Class14 local45 = Static163.aClass19_17.method8010(local36, Static735.method9375(client.sprites, Static539.anInt8173), true);
			...
			label216: {
				try {
					...
					if (arg0 != null) {
						...
						@Pc(127) Class14 local127 = local57.method8010(local118, Static735.method9375(client.sprites, Static539.anInt8173), true);
						Static288.method4182();
