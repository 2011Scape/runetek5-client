...
public final class TextureOpRasterizer extends TextureOp {
	...
	public int[] method9411(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aMonochromeImageCache41.aBoolean338) {
			this.method6410(super.aMonochromeImageCache41.method3932());
		}
		return local16;
	}
	...
	public int[][] method9414(@OriginalArg(0) int arg0) {
		@Pc(17) int[][] local17 = super.aColorImageCache41.method8450(arg0);
		if (super.aColorImageCache41.aBoolean737) {
			@Pc(23) int local23 = Static608.anInt9289;
			@Pc(25) int local25 = Static2.anInt53;
			@Pc(29) int[][] local29 = new int[local25][local23];
			@Pc(34) int[][][] local34 = super.aColorImageCache41.method8451();
