...
public final class Preference_Sub23 extends Preference {
	...
	public int method8352(@OriginalArg(0) int arg0) {
		if (super.aClass2_Sub34_34.method5111()) {
			return 3;
		} else if (super.aClass2_Sub34_34.method5105() == ModeGame.GAME_RUNESCAPE) {
			if (arg0 == 0) {
				if (super.aClass2_Sub34_34.aPreference_Sub16_1.method5507() == 1) {
					return 2;
				}
				if (super.aClass2_Sub34_34.aPreference_Sub30_1.method8356() == 1) {
					return 2;
				}
				if (super.aClass2_Sub34_34.aPreference_Sub26_1.method7463() > 0) {
					return 2;
				}
			}
			return 1;
	...
	public boolean method7053() {
		if (super.aClass2_Sub34_34.method5111()) {
			...
			return super.aClass2_Sub34_34.method5105() == ModeGame.GAME_RUNESCAPE;
		}
	}
