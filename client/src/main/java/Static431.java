...
public final class Static431 {
	...
	public static void method5822(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5, @OriginalArg(7) int arg6, @OriginalArg(8) int arg7, @OriginalArg(9) int arg8, @OriginalArg(10) int arg9, @OriginalArg(11) int arg10) {
		if (!Static571.load(arg7)) {
			return;
		}
		if (Static148.aComponentArrayArray1[arg7] == null) {
			Static84.method1669(Static453.components[arg7], -1, arg10, arg2, arg5, arg0, arg6, arg1, arg8, arg3, arg9, arg4);
		} else {
	...
	public static void method5827(@OriginalArg(0) SeqType arg0, @OriginalArg(1) int arg1, @OriginalArg(2) ParticleNode_Sub2 arg2) {
		if (Static33.anInt779 >= 50 || (arg0 == null || arg0.soundeffect == null || arg0.soundeffect.length <= arg1 || arg0.soundeffect[arg1] == null)) {
			return;
		}
		@Pc(51) int local51 = arg0.soundeffect[arg1][0];
		@Pc(55) int local55 = local51 >> 8;
		@Pc(61) int local61 = local51 >> 5 & 0x7;
		@Pc(80) int local80;
		if (arg0.soundeffect[arg1].length > 1) {
			local80 = (int) (Math.random() * (double) arg0.soundeffect[arg1].length);
			if (local80 > 0) {
				local55 = arg0.soundeffect[arg1][local80];
			}
		}
		...
		if (local93 == 0) {
			if (arg2 == Static556.self) {
				if (!arg0.aBoolean141) {
					Static161.play(local80, 0, local55, local61, local134);
					return;
				}
			...
			@Pc(184) int local184 = arg2.xFine - 256 >> 9;
			@Pc(191) int local191 = arg2.zFine - 256 >> 9;
			@Pc(212) int local212 = arg2 == Static556.self ? 0 : local93 + (local191 << 8) + (local184 << 16) + (arg2.plane << 24);
