...
public abstract class ParticleNode_Sub2_Sub5 extends ParticleNode_Sub2 {

	@OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(IIIII)V")
	public ParticleNode_Sub2_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		super.xFine = arg0;
	...
	@Override
	public final void method9285(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) Class19 arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte arg4, @OriginalArg(5) int arg5, @OriginalArg(6) ParticleNode_Sub2 arg6) {
		if (arg4 >= 101) {
