...
public final class Linkable_Sub33 extends Linkable {
	...
	private final Linkable_Sub7 aClass2_Sub7_2;
	...
	private HashTable aHashTable26;

	@OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lclient!qha;Lclient!pn;Lclient!lca;[I)V")
	public Linkable_Sub33(@OriginalArg(0) Class19_Sub3 arg0, @OriginalArg(1) Class178_Sub2 arg1, @OriginalArg(2) Linkable_Sub7 arg2, @OriginalArg(3) int[] arg3) {
	...
	private void method4932(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		if ((arg1 & 0x7F) == 0 || (arg0 & 0x7F) == 0) {
			...
			@Pc(64) Linkable local64 = this.aHashTable26.get(local7);
			if (local64 != null) {
				this.method4934(((Linkable_Sub50) local64).aShort119);
				return;
			}
		}
		@Pc(83) short local83 = (short) this.anInt5452++;
		if (local7 != -1L) {
			this.aHashTable26.put(local7, new Linkable_Sub50(local83));
		}
