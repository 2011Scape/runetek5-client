			...
			while (true) {
				...
				while (!local26) {
					...
					if (local75 > 0 && local79 > 0 && arg2 - 1 > local75 && arg4 - 1 > local79) {
						@Pc(111) LocType local111 = Static354.aLocTypeList4.get(local12);
						if (local71 != 22 || Static400.aClass2_Sub34_28.aPreference_Sub6_1.method2714() != 0 || local111.active != 0 || local111.blockwalk == 1 || local111.forcedecor) {
							local26 = true;
