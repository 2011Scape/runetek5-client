...
public final class SoundPcmStream extends PcmStream {
	...
	public synchronized void method9131(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(13) PcmSound local13 = (PcmSound) super.aClass2_Sub49_6;
	...
	public boolean method3311() {
		return this.anInt3686 < 0 || this.anInt3686 >= ((PcmSound) super.aClass2_Sub49_6).aByteArray98.length << 8;
	}
	...
	public synchronized void method9130(@OriginalArg(0) int arg0) {
		...
		@Pc(71) PcmSound local71 = (PcmSound) super.aClass2_Sub49_6;
	...
	public synchronized void method3344(@OriginalArg(0) int arg0) {
		@Pc(7) int local7 = ((PcmSound) super.aClass2_Sub49_6).aByteArray98.length << 8;
		if (arg0 < -1) {
			arg0 = -1;
		}
		if (arg0 > local7) {
	...
	public int method9136() {
		...
		if (this.anInt3688 == 0) {
			local6 -= local6 * this.anInt3686 / (((PcmSound) super.aClass2_Sub49_6).aByteArray98.length << 8);
		} else if (this.anInt3688 >= 0) {
			local6 -= local6 * this.anInt3681 / ((PcmSound) super.aClass2_Sub49_6).aByteArray98.length;
		}
