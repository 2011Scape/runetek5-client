...
public final class Static46 {
	...
	public static int getFreeSpace(@OriginalArg(2) int arg0) {
		@Pc(13) Linkable_Sub22 local13 = Static556.method7303(arg0, false);
		if (local13 == null) {
			return Static503.aInvTypeList1.get(arg0).size;
		}
		@Pc(24) int local24 = 0;
		...
		return local24 + Static503.aInvTypeList1.get(arg0).size - local13.anIntArray278.length;
	}
