...
public final class Static553 {
	...
	public static void method7289(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(7) Linkable_Sub25 local7 = null;
		for (@Pc(12) Linkable_Sub25 local12 = (Linkable_Sub25) Static159.aLinkedList15.head(); local12 != null; local12 = (Linkable_Sub25) Static159.aLinkedList15.next()) {
		...
		if (local7 == null) {
			...
			Static159.aLinkedList15.addTail(local7);
		}
	...
	public static void method7290() {
		Static627.aSoftLruHashTable200.removeSoft();
	}
}
