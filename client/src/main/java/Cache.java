...
public final class Cache {
	...
	private BufferedFile aBufferedFile2 = null;

	@OriginalMember(owner = "client!af", name = "i", descriptor = "Lclient!mj;")
	private BufferedFile aBufferedFile3 = null;
	...
	public Cache(@OriginalArg(0) int arg0, @OriginalArg(1) BufferedFile arg1, @OriginalArg(2) BufferedFile arg2, @OriginalArg(3) int arg3) {
		this.aBufferedFile3 = arg2;
		this.anInt118 = arg0;
		this.anInt114 = arg3;
		this.aBufferedFile2 = arg1;
	}
	...
	public boolean method125(@OriginalArg(0) int arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2) {
		@Pc(6) BufferedFile local6 = this.aBufferedFile2;
		synchronized (this.aBufferedFile2) {
	...
	public byte[] method126(@OriginalArg(0) int arg0) {
		...
		synchronized (this.aBufferedFile2) {
			try {
				if (this.aBufferedFile3.method5564() < (long) (arg0 * 6 + 6)) {
					return null;
				}
				this.aBufferedFile3.method5568((long) (arg0 * 6));
				this.aBufferedFile3.method5559(6, Static294.aByteArray49, 0);
				...
				if (local67 < 0 || local67 > this.anInt114) {
					return null;
				} else if (local89 > 0 && this.aBufferedFile2.method5564() / 520L >= (long) local89) {
					...
					while (local67 > local131) {
						...
						this.aBufferedFile2.method5568((long) (local89 * 520));
						@Pc(161) int local161 = local67 - local131;
						if (local161 > 512) {
							local161 = 512;
						}
						this.aBufferedFile2.method5559(local161 + 8, Static294.aByteArray49, 0);
						...
						if (arg0 == local191 && local140 == local205 && local233 == this.anInt118) {
							if (local227 >= 0 && (long) local227 <= this.aBufferedFile2.method5564() / 520L) {
								local140++;
	...
	private boolean method128(@OriginalArg(0) byte[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) boolean arg3) {
		@Pc(8) BufferedFile local8 = this.aBufferedFile2;
		synchronized (this.aBufferedFile2) {
			try {
				@Pc(84) int local84;
				if (arg3) {
					if (this.aBufferedFile3.method5564() < (long) (arg1 * 6 + 6)) {
						return false;
					}
					this.aBufferedFile3.method5568((long) (arg1 * 6));
					this.aBufferedFile3.method5559(6, Static294.aByteArray49, 0);
					local84 = (Static294.aByteArray49[5] & 0xFF) + (((Static294.aByteArray49[3] & 0xFF) << 16) + ((Static294.aByteArray49[4] & 0xFF) << 8));
					if (local84 <= 0 || this.aBufferedFile2.method5564() / 520L < (long) local84) {
						return false;
					}
				} else {
					local84 = (int) ((this.aBufferedFile2.method5564() + 519L) / 520L);
					if (local84 == 0) {
						local84 = 1;
					}
				}
				...
				this.aBufferedFile3.method5568((long) (arg1 * 6));
				this.aBufferedFile3.method5561(0, 6, Static294.aByteArray49);
				...
				while (true) {
					if (local173 < arg2) {
						label102: {
							...
							@Pc(217) int local217;
							if (arg3) {
								this.aBufferedFile2.method5568((long) (local84 * 520));
								try {
									this.aBufferedFile2.method5559(8, Static294.aByteArray49, 0);
								...
								if (local181 < 0 || this.aBufferedFile2.method5564() / 520L < (long) local181) {
									return false;
								}
							}
							if (local181 == 0) {
								arg3 = false;
								local181 = (int) ((this.aBufferedFile2.method5564() + 519L) / 520L);
								if (local181 == 0) {
									local181++;
								}
								if (local181 == local84) {
							...
							this.aBufferedFile2.method5568((long) (local84 * 520));
							this.aBufferedFile2.method5561(0, 8, Static294.aByteArray49);
							local217 = arg2 - local173;
							if (local217 > 512) {
								local217 = 512;
							}
							this.aBufferedFile2.method5561(local173, local217, arg0);
							local84 = local181;
							local173 += local217;
							local175++;
							continue;
