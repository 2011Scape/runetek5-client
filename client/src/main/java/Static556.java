	...
	public static void method7301(@OriginalArg(0) Class19 arg0) {
		...
		if (Static156.aBoolean223 && Static594.anInt8777 < 2) {
			...
			if (Static245.method8635(local55.anInt7314)) {
				local65 = ObjTypeList.objTypes.method2486((int) local55.aLong233).anIntArray800;
			} else if (local55.anInt7317 != -1) {
				local65 = ObjTypeList.objTypes.method2486(local55.anInt7317).anIntArray800;
				...
				@Pc(131) LocType local131 = Static354.aLocTypeList4.get((int) (local55.aLong233 >>> 32 & 0x7FFFFFFFL));
				if (local131.multiloc != null) {
