...
public final class ProjAnimEntity extends Entity {
	...
	private Model method814(@OriginalArg(0) int arg0, @OriginalArg(1) Class19 arg1, @OriginalArg(2) int arg2) {
	...
	public void method816() {
		...
		if (Static1.anInt10798 == 3) {
			...
			if (this.anInt706 < 0) {
				...
				local35 = this.anInt706 - 1;
				@Pc(58) Linkable_Sub45 local58 = (Linkable_Sub45) Static18.aHashTable2.get((long) local35);
				if (local58 != null) {
	...
	private void method817(@OriginalArg(1) Class19 arg0, @OriginalArg(2) Class73 arg1, @OriginalArg(3) Model arg2) {
	...
	public ParticleNode_Sub7 method9276(@OriginalArg(1) Class19 arg0) {
		...
		@Pc(57) ParticleNode_Sub7 local57 = Static642.method8441(false, 1);
