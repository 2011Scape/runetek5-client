...
public final class Static571 {
	...
	public static boolean load(@OriginalArg(1) int arg0) {
		if (Static132.aBooleanArray5[arg0]) {
			...
			if (Static453.components[arg0] == null) {
				Static453.components[arg0] = new Component[local25];
			}
			for (@Pc(53) int local53 = 0; local53 < local25; local53++) {
				if (Static453.components[arg0][local53] == null) {
					@Pc(66) byte[] local66 = Static666.aJs5118.fetchFile(arg0, local53);
					if (local66 != null) {
						@Pc(78) Component local78 = Static453.components[arg0][local53] = new Component();
						local78.id = local53 + (arg0 << 16);
						if (local66[0] != -1) {
							throw new IllegalStateException("if1");
						}
						local78.decodeIf3(new Packet(local66));
					}
				}
			}
			Static132.aBooleanArray5[arg0] = true;
