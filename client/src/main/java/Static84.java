...
public final class Static84 {
		...
		for (@Pc(21) int local21 = 0; local21 < local9; local21++) {
			...
			if (Static1.anInt10798 == 3) {
				...
				if (local21 < local1) {
					...
					local36 = ((Linkable_Sub45) Static18.aHashTable2.get((long) Static103.anIntArray187[local21 - local1])).aClass8_Sub2_Sub1_Sub2_Sub2_2;
				}
			...
			if ((local68 & 0x1) == 0) {
				if ((local36.xFine & 0x1FF) == 0 && (local36.zFine & 0x1FF) == 0) {
					continue;
				}
			} else if ((local36.xFine & 0x1FF) == 256 && (local36.zFine & 0x1FF) == 256) {
				continue;
			}
			local36.anInt10691 = Static102.method2025(local36.plane, -29754, local36.zFine, local36.xFine);
	...
	public static void method1654(@OriginalArg(0) int arg0) {
		...
		for (@Pc(21) int local21 = 0; local21 < local9; local21++) {
			...
			if (Static1.anInt10798 != 3) {
				...
				@Pc(166) int local166;
				if (local80 == 1) {
					local135 = local36.xFine >> 9;
					local140 = local36.zFine >> 9;
					...
					local140 = local36.xFine - local135 >> 9;
					@Pc(196) int local196 = local36.zFine - local135 >> 9;
					@Pc(203) int local203 = local36.xFine + local135 >> 9;
					@Pc(210) int local210 = local36.zFine + local135 >> 9;
	...
	public static void method1655() {
		...
		for (@Pc(32) int local32 = 0; local32 < local1; local32++) {
			@Pc(39) Player local39 = Static621.aClass8_Sub2_Sub1_Sub2_Sub1Array3[local3[local32]];
			if (!local39.method1417()) {
				...
				if (local39.aShort131 >= 0 && local39.aShort132 >= 0 && local39.aShort134 < Static720.anInt10859 && local39.aShort133 < Static501.anInt7568) {
					...
					if (local39 == Static556.self) {
						...
						if (local39.anInt10747 > Static333.loop) {
							local103 += 2;
						}
		...
		for (@Pc(155) int local155 = 0; local155 < Static390.anInt6126; local155++) {
			@Pc(166) Npc local166 = ((Linkable_Sub45) Static18.aHashTable2.get((long) Static103.anIntArray187[local155])).aClass8_Sub2_Sub1_Sub2_Sub2_2;
			if (local166.method9322() && local166.aNpcType1.method5996(Static34.aClass304_1)) {
				local166.method9294();
				if (local166.aShort131 >= 0 && local166.aShort132 >= 0 && local166.aShort134 < Static720.anInt10859 && local166.aShort133 < Static501.anInt7568) {
					...
					if (local166.anInt10747 > Static333.loop) {
						local213 += 2;
					}
					local213 += 5 - local166.method9302((byte) 88) << 2;
					if (Static150.anInt2632 == 0) {
						if (local166.aNpcType1.aBoolean504) {
							local213 += 64;
						} else {
							local213 += 128;
						}
					...
					if (local166.aNpcType1.aBoolean502) {
						local213 += 1024;
					} else if (!local166.aNpcType1.aBoolean503) {
						local213 += 256;
					}
		...
		for (local103 = 0; local103 < Static527.aClass254Array1.length; local103++) {
			...
			if (local292 != null) {
				if (local292.anInt6363 == 1) {
					@Pc(308) Linkable_Sub45 local308 = (Linkable_Sub45) Static18.aHashTable2.get((long) local292.anInt6366);
					if (local308 != null) {
						@Pc(313) Npc local313 = local308.aClass8_Sub2_Sub1_Sub2_Sub2_2;
						if (local313.anInt10739 >= 0) {
							local313.anInt10739 += 2048;
						}
					}
				} else if (local292.anInt6363 == 10) {
					@Pc(333) Player local333 = Static621.aClass8_Sub2_Sub1_Sub2_Sub1Array3[local292.anInt6366];
					if (local333 != null && local333 != Static556.self && local333.anInt10739 >= 0) {
	...
	public static Component method1657(@OriginalArg(0) Component arg0) {
		...
		for (@Pc(11) int local11 = 0; local11 < local4; local11++) {
			arg0 = Static145.getComponent(arg0.overlayer);
			if (arg0 == null) {
				return null;
			}
		}
	...
	public static ServerActiveProperties getServerActiveProperties(@OriginalArg(0) Component arg0) {
		@Pc(13) ServerActiveProperties local13 = (ServerActiveProperties) Static291.aHashTable24.get(((long) arg0.id << 32) + (long) arg0.createdComponentId);
		return local13 == null ? arg0.aClass2_Sub41_2 : local13;
	}

	@OriginalMember(owner = "client!client", name = "a", descriptor = "(BLclient!pg;)V")
	public static void method1662(@OriginalArg(1) SecondaryLinkable_Sub16 arg0) {
		if (arg0 == null) {
			return;
		}
		Static693.aLinkedList79.addTail(arg0);
		Static594.anInt8777++;
		@Pc(33) SecondaryLinkable_Sub4 local33;
		if (arg0.aBoolean551 || "".equals(arg0.aString86)) {
			local33 = new SecondaryLinkable_Sub4(arg0.aString86);
			Static31.anInt767++;
		} else {
			...
			if (local33 == null) {
				...
				Static490.aHashTable34.put(local41, local33);
				Static31.anInt767++;
			}
		}
		...
		for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
			...
			if (local11 != null) {
				if (local11.type == 0) {
					...
					@Pc(38) SubInterface local38 = (SubInterface) Static548.openInterfaces.get((long) local11.id);
					if (local38 != null) {
						Static145.method2411(arg1, local38.interfaceId);
					}
				}
				@Pc(58) Linkable_Sub42 local58;
				if (arg1 == 0 && local11.onDialogAbort != null) {
					local58 = new Linkable_Sub42();
					local58.aComponent14 = local11;
					local58.anObjectArray36 = local11.onDialogAbort;
					Static472.method6420(local58);
				}
				if (arg1 == 1 && local11.onWidgetsOpenClose != null) {
					if (local11.createdComponentId >= 0) {
						@Pc(88) Component local88 = Static145.getComponent(local11.id);
						if (local88 == null || local88.createdComponents == null || local88.createdComponents.length <= local11.createdComponentId || local88.createdComponents[local11.createdComponentId] != local11) {
							continue;
						}
					}
					local58 = new Linkable_Sub42();
					local58.aComponent14 = local11;
					local58.anObjectArray36 = local11.onWidgetsOpenClose;
					Static472.method6420(local58);
				}
			}
		}
	...
	public static void method1664() {
		...
		for (@Pc(3) int local3 = 0; local3 < Static390.anInt6126; local3++) {
			@Pc(14) Npc local14 = ((Linkable_Sub45) Static18.aHashTable2.get((long) Static103.anIntArray187[local3])).aClass8_Sub2_Sub1_Sub2_Sub2_2;
			if (local14.aBoolean816 && local14.method9304((byte) -123) != -1) {
				@Pc(34) int local34 = (local14.method9302((byte) 63) - 1) * 256 + 252;
				@Pc(41) int local41 = local14.xFine - local34 >> 9;
				@Pc(48) int local48 = local14.zFine - local34 >> 9;
				@Pc(55) PathingEntity local55 = Static184.method2798(local41, local48, local14.plane);
				if (local55 != null) {
					@Pc(60) int local60 = local55.anInt10740;
					if (local55 instanceof Npc) {
						local60 += 2048;
					}
	...
	public static void method1669(@OriginalArg(0) Component[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11) {
		label908: for (@Pc(1) int local1 = 0; local1 < arg0.length; local1++) {
			...
			if (local6 != null && local6.overlayer == arg1) {
				@Pc(19) int local19 = local6.x + arg6;
				@Pc(24) int local24 = local6.y + arg7;
				@Pc(30) int local30;
				@Pc(32) int local32;
				@Pc(34) int local34;
				@Pc(36) int local36;
				...
				if (local6.type == 0 || local6.aBoolean297 || getServerActiveProperties(local6).events != 0 || local6 == Static354.aComponent8 || local6.clientCode == Static496.anInt7433 || local6.clientCode == Static625.anInt9471 || local6.clientCode == Static188.anInt3104 || local6.clientCode == Static190.anInt3113) {
					if (!method1660(local6)) {
						...
						if (local6 == Static109.aComponent3 && Static582.method7658(Static109.aComponent3) != null) {
						...
						if (local6.aBoolean296 || local30 < local34 && local32 < local36) {
							if (local6.aBoolean300 && arg10 >= local30 && arg11 >= local32 && arg10 < local34 && arg11 < local36) {
								for (@Pc(220) Linkable_Sub42 local220 = (Linkable_Sub42) Static521.lowPriorityRequests.head(); local220 != null; local220 = (Linkable_Sub42) Static521.lowPriorityRequests.next()) {
									if (local220.aBoolean544) {
										local220.unlink();
										local220.aComponent14.aBoolean298 = false;
									}
								}
								if (Static181.anInt3003 == 0) {
									Static109.aComponent3 = null;
									Static354.aComponent8 = null;
								}
							...
							@Pc(308) boolean local308 = local6.aBoolean295 && local6.type == 5 && local6.alpha == 0 && local6.anInt3824 < 0 && local6.objId == -1 && local6.anInt3745 == -1 && !local6.aBoolean301 && local6.angle2d == 0;
							@Pc(310) boolean local310 = false;
							@Pc(402) int local402;
							if (Static189.aMouse1.method8853() + local42 >= local30 && Static189.aMouse1.method8854() + local47 >= local32 && Static189.aMouse1.method8853() + local42 < local34 && Static189.aMouse1.method8854() + local47 < local36) {
								if (local308) {
									...
									if (local353 != null && local353.anInt3832 == local6.width && local353.anInt3833 == local6.height) {
										@Pc(380) int local380 = Static189.aMouse1.method8853() + local42 - local19;
										@Pc(388) int local388 = Static189.aMouse1.method8854() + local47 - local24;
							...
							if (Static189.aMouse1.method8842() && local310) {
								local462 = true;
							}
							@Pc(474) boolean local474 = false;
							@Pc(479) Linkable_Sub9 local479 = (Linkable_Sub9) Static226.aLinkedList58.head();
							@Pc(549) int local549;
							@Pc(555) int local555;
							@Pc(569) int local569;
							...
							if (local6.aByteArray37 != null && !Static607.method8163()) {
								for (local402 = 0; local402 < local6.aByteArray37.length; local402++) {
									if (Static334.aKeyboard1.method8479(local6.aByteArray37[local402])) {
										if (local6.anIntArray294 == null || Static333.loop >= local6.anIntArray294[local402]) {
											@Pc(634) byte local634 = local6.aByteArray36[local402];
											if (local634 == 0 || ((local634 & 0x8) == 0 || !Static334.aKeyboard1.method8479(86) && !Static334.aKeyboard1.method8479(82) && !Static334.aKeyboard1.method8479(81)) && ((local634 & 0x2) == 0 || Static334.aKeyboard1.method8479(86)) && ((local634 & 0x1) == 0 || Static334.aKeyboard1.method8479(82)) && ((local634 & 0x4) == 0 || Static334.aKeyboard1.method8479(81))) {
												if (local402 < 10) {
													Static120.method2193(local6.id, -1, "", local402 + 1);
												} else if (local402 == 10) {
													Static470.method6384();
													@Pc(726) ServerActiveProperties local726 = getServerActiveProperties(local6);
													...
													Static128.aString108 = local6.optionBase + "<col=ffffff>";
												}
												...
												if (local555 == 0) {
													...
													local6.anIntArray294[local402] = Static333.loop + local555;
												}
											}
										}
							...
							if (Static109.aComponent3 != null && Static109.aComponent3 != local6 && local310 && getServerActiveProperties(local6).isDragTarget()) {
								Static327.aComponent7 = local6;
							}
							if (local6 == Static354.aComponent8) {
								Static343.aBoolean428 = true;
								Static123.anInt2341 = local19;
								Static169.anInt2853 = local24;
							}
							if (local6.aBoolean297 || local6.clientCode != 0) {
								@Pc(877) Linkable_Sub42 local877;
								if (local310 && Static611.anInt9341 != 0 && local6.onScroll != null) {
									local877 = new Linkable_Sub42();
									local877.aBoolean544 = true;
									local877.aComponent14 = local6;
									local877.anInt7214 = Static611.anInt9341;
									local877.anObjectArray36 = local6.onScroll;
									Static521.lowPriorityRequests.addTail(local877);
								}
								if (Static109.aComponent3 != null) {
									local474 = false;
									local462 = false;
								} else if (Static400.aBoolean622 || local6.clientCode != Static58.anInt1177 && Static460.anInt6964 > 0) {
									local474 = false;
									local462 = false;
									local310 = false;
								}
								if (local6.clientCode != 0) {
									if (local6.clientCode == Static188.anInt3104 || local6.clientCode == Static190.anInt3113) {
										Static610.aComponent16 = local6;
										if (Static456.aClass148_3 != null) {
											Static456.aClass148_3.method3168(Static400.aClass2_Sub34_28.aPreference_Sub2_1.method1989(), local6.height, Static163.aClass19_17);
										}
										if (local6.clientCode == Static188.anInt3104) {
											...
											@Pc(991) ParticleNode_Sub1 local991 = (ParticleNode_Sub1) Static149.aParticleLinkedList4.method2790();
											while (true) {
												if (local991 == null) {
													continue label908;
												}
												...
												local991 = (ParticleNode_Sub1) Static149.aParticleLinkedList4.method2785();
											}
										}
									}
									if (local6.clientCode == Static496.anInt7433) {
										local524 = local6.method3393(Static163.aClass19_17);
										...
										if (Static511.cameraType == 4) {
											...
											local1191 = (Static556.self.xFine - local1208 >> 9) + (local1170 >> 2);
											local1199 = (Static556.self.zFine - local1208 >> 9) - (local1180 >> 2);
										}
										if (Static156.aBoolean223 && (Static717.anInt10822 & 0x40) != 0) {
											...
											if (local1243 == null) {
												...
												Static416.method5707(false, local6.objId, 1L, local1191, local1199, Static153.aString27, 21, true, Static369.anInt4263, " ->", (long) (local6.createdComponentId << 0 | local6.id), true);
											}
											continue;
										}
									...
									if (local6.clientCode == Static58.anInt1177) {
										Static210.aComponent4 = local6;
										if (local310) {
											Static95.aBoolean184 = true;
										}
										if (local474) {
											local402 = (int) ((double) (local42 + local479.method5331() - local19 - local6.width / 2) * 2.0D / (double) Static30.aFloat105);
											local549 = (int) -((double) (local47 + local479.method5333() - local24 - local6.height / 2) * 2.0D / (double) Static30.aFloat105);
											...
											if (local1388 != null) {
												if (Static334.aKeyboard1.method8479(82) && Static608.staffModLevel > 0) {
											...
											Static378.anInt5941 = Static189.aMouse1.method8853();
											Static150.anInt2631 = Static189.aMouse1.method8854();
											continue;
										}
										if (local462 && Static460.anInt6964 > 0) {
											if (Static460.anInt6964 == 1 && (Static378.anInt5941 != Static189.aMouse1.method8853() || Static150.anInt2631 != Static189.aMouse1.method8854())) {
											...
											if (Static460.anInt6964 == 2) {
												...
												Static669.method8711(Static661.anInt6055 + (int) ((double) (Static378.anInt5941 - Static189.aMouse1.method8853()) * 2.0D / (double) Static30.aFloat106));
												Static182.method2786(Static417.anInt6399 - (int) ((double) (Static150.anInt2631 - Static189.aMouse1.method8854()) * 2.0D / (double) Static30.aFloat106));
											}
											continue;
										}
									...
									if (local6.clientCode == Static146.anInt2567) {
										if (local462) {
											Static203.method3069(local6.width, local42 + Static189.aMouse1.method8853() - local19, local47 + Static189.aMouse1.method8854() - local24, local6.height);
										}
										continue;
									}
									if (local6.clientCode == Static625.anInt9471) {
								...
								if (local6.aBoolean290 && local462 && local6.onDrag != null) {
									local877 = new Linkable_Sub42();
									local877.aBoolean544 = true;
									local877.aComponent14 = local6;
									local877.anInt7218 = local42 + Static189.aMouse1.method8853() - local19;
									local877.anInt7214 = local47 + Static189.aMouse1.method8854() - local24;
									local877.anObjectArray36 = local6.onDrag;
									Static521.lowPriorityRequests.addTail(local877);
								}
								if (local6.aBoolean290 && !local462) {
									...
									if (local6.onRelease != null) {
										...
										Static59.mediumPriorityRequests.addTail(local877);
									}
								}
								...
								if (local6.onTimer != null) {
									...
									Static618.highPriorityRequests.addTail(local877);
								}
								@Pc(2022) Linkable_Sub42 local2022;
										...
										label768: for (local402 = local6.anInt3805; local402 < Static52.anInt1065; local402++) {
											...
											for (local555 = 0; local555 < local6.varcTriggers.length; local555++) {
												if (local6.varcTriggers[local555] == local549) {
													local2022 = new Linkable_Sub42();
													local2022.aComponent14 = local6;
													local2022.anObjectArray36 = local6.onVarcTransmit;
													Static521.lowPriorityRequests.addTail(local2022);
													break label768;
												}
											}
										}
								...
								if (local6.onVarpTransmit != null && Static635.anInt9525 > local6.anInt3761) {
									if (local6.varpTriggers == null || Static635.anInt9525 - local6.anInt3761 > 32) {
										local877 = new Linkable_Sub42();
										local877.aComponent14 = local6;
										local877.anObjectArray36 = local6.onVarpTransmit;
										Static521.lowPriorityRequests.addTail(local877);
									} else {
										label720: for (local402 = local6.anInt3761; local402 < Static635.anInt9525; local402++) {
											...
											for (local555 = 0; local555 < local6.varpTriggers.length; local555++) {
												if (local6.varpTriggers[local555] == local549) {
													local2022 = new Linkable_Sub42();
													local2022.aComponent14 = local6;
													local2022.anObjectArray36 = local6.onVarpTransmit;
													Static521.lowPriorityRequests.addTail(local2022);
													break label720;
												}
											}
								...
								if (Static716.anInt10815 > local6.lb && local6.onMsg != null) {
									local877 = new Linkable_Sub42();
									local877.aComponent14 = local6;
									local877.anObjectArray36 = local6.onMsg;
									Static521.lowPriorityRequests.addTail(local877);
								}
								if (Static344.anInt5621 > local6.lb && local6.onFriendTransmit != null) {
									local877 = new Linkable_Sub42();
									local877.aComponent14 = local6;
									local877.anObjectArray36 = local6.onFriendTransmit;
									Static521.lowPriorityRequests.addTail(local877);
								}
								if (Static352.anInt5754 > local6.lb && local6.onClanTransmit != null) {
									local877 = new Linkable_Sub42();
									local877.aComponent14 = local6;
									local877.anObjectArray36 = local6.onClanTransmit;
									Static521.lowPriorityRequests.addTail(local877);
								}
								...
								if (Static526.anInt8067 > local6.lb && local6.onStockTransmit != null) {
									local877 = new Linkable_Sub42();
									local877.aComponent14 = local6;
									local877.anObjectArray36 = local6.onStockTransmit;
									Static521.lowPriorityRequests.addTail(local877);
								}
								if (Static321.anInt5111 > local6.lb && local6.onMiscTransmit != null) {
									local877 = new Linkable_Sub42();
									local877.aComponent14 = local6;
									local877.anObjectArray36 = local6.onMiscTransmit;
									Static521.lowPriorityRequests.addTail(local877);
								}
								local6.lb = Static642.anInt9599;
								if (local6.onKey != null) {
									for (local402 = 0; local402 < Static671.anInt10026; local402++) {
										@Pc(2682) Linkable_Sub42 local2682 = new Linkable_Sub42();
										local2682.aComponent14 = local6;
										...
										local2682.anObjectArray36 = local6.onKey;
										Static521.lowPriorityRequests.addTail(local2682);
									}
								}
								if (Static272.aBoolean337 && local6.onMinimapUnlock != null) {
									local877 = new Linkable_Sub42();
									local877.aComponent14 = local6;
									local877.anObjectArray36 = local6.onMinimapUnlock;
									Static521.lowPriorityRequests.addTail(local877);
								}
							}
							if (local6.type == 5 && local6.anInt3824 != -1) {
								local6.method3405(Static99.aSkyBoxSphereTypeList1, Static324.aSkyBoxTypeList1).method3168(Static400.aClass2_Sub34_28.aPreference_Sub2_1.method1989(), local6.height, Static163.aClass19_17);
							}
							Static542.method7202(local6);
							if (local6.type == 0) {
								method1669(arg0, local6.id, local30, local32, local34, local36, local19 - local6.scrollX, local24 - local6.scrollY, arg8, arg9, arg10, arg11);
								if (local6.aComponentArray1 != null) {
									method1669(local6.aComponentArray1, local6.id, local30, local32, local34, local36, local19 - local6.scrollX, local24 - local6.scrollY, arg8, arg9, arg10, arg11);
								}
								@Pc(2824) SubInterface local2824 = (SubInterface) Static548.openInterfaces.get((long) local6.id);
								if (local2824 != null) {
									...
									Static431.method5822(local36, local24, local32, arg9, arg11, local34, local19, local2824.interfaceId, arg8, arg10, local30);
								}
							}
						}
					}
		...
		for (@Pc(16) int local16 = 0; local16 < local9; local16++) {
			...
			if (Static1.anInt10798 == 3) {
				...
				if (local16 < local1) {
					...
					local31 = ((Linkable_Sub45) Static18.aHashTable2.get((long) Static103.anIntArray187[local16 - local1])).aClass8_Sub2_Sub1_Sub2_Sub2_2;
				}
				if (local31.plane != arg0 || local31.anInt10739 < 0) {
					continue;
				}
			}
			@Pc(69) int local69 = local31.method9302((byte) 102);
			if ((local69 & 0x1) == 0) {
				if ((local31.xFine & 0x1FF) != 0 || (local31.zFine & 0x1FF) != 0) {
					continue;
				}
			} else if ((local31.xFine & 0x1FF) != 256 || (local31.zFine & 0x1FF) != 256) {
				continue;
			}
			@Pc(113) int local113;
			@Pc(118) int local118;
			@Pc(155) int local155;
			if (local69 == 1) {
				local113 = local31.xFine >> 9;
				local118 = local31.zFine >> 9;
				...
				local118 = local31.xFine - local113 >> 9;
				@Pc(182) int local182 = local31.zFine - local113 >> 9;
				@Pc(189) int local189 = local31.xFine + local113 >> 9;
				@Pc(196) int local196 = local31.zFine + local113 >> 9;
