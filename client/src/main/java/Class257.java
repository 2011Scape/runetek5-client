...
public final class Class257 {
	...
	public boolean method5769(@OriginalArg(0) SeqTypeList arg0, @OriginalArg(2) SeqType arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int[] arg4) {
		if (this.aBoolean481) {
			...
			this.aClass2_Sub2_Sub18_1 = arg0.getAnimFrameset(this.anInt6448 >> 16);
			this.anInt6448 &= 0xFFFF;
			if (this.aClass2_Sub2_Sub18_1 == null) {
				return false;
			}
			if (arg1.tween && arg2 != -1 && arg4.length > arg2) {
				this.anInt6450 = arg4[arg2];
				this.aClass2_Sub2_Sub18_2 = arg0.getAnimFrameset(this.anInt6450 >> 16);
