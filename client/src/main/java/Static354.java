...
public final class Static354 {
	...
	public static Component aComponent8 = null;
	...
	public static void method5181(@OriginalArg(1) PathingEntity arg0) {
		...
		if (Static333.loop == arg0.anInt10755 || !local6.method9109() || local6.method9090()) {
			@Pc(34) int local34 = arg0.anInt10755 - arg0.anInt10759;
			@Pc(40) int local40 = Static333.loop - arg0.anInt10759;
			...
			arg0.xFine = (local76 * local40 + local52 * (local34 - local40)) / local34;
			arg0.zFine = (local40 * local88 + local64 * (local34 - local40)) / local34;
		}
		arg0.anInt10763 = 0;
