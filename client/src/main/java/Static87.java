...
public final class Static87 {
	...
	public static final ServerProt ServerProt37 = new ServerProt(97, -1);

	@OriginalMember(owner = "client!cn", name = "l", descriptor = "Lclient!ss;")
	public static final ClientProt aClientProt17 = new ClientProt(35, 7);
	...
	public static void method1693(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2, @OriginalArg(3) Class19 arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		if (Static459.aSoftwareIndexedSprite31 == null || Static1.aSoftwareIndexedSprite42 == null) {
			if (Static721.aJs5128.method7581(Static63.anInt1474) && Static721.aJs5128.method7581(Static282.anInt4417)) {
		...
		if (Static459.aSoftwareIndexedSprite31 != null && Static1.aSoftwareIndexedSprite42 != null) {
			@Pc(82) int local82 = (arg0 - Static1.aSoftwareIndexedSprite42.method8199() * 2) / Static459.aSoftwareIndexedSprite31.method8199();
			for (@Pc(84) int local84 = 0; local84 < local82; local84++) {
				Static459.aSoftwareIndexedSprite31.method8202(arg5 + Static1.aSoftwareIndexedSprite42.method8199() + local84 * Static459.aSoftwareIndexedSprite31.method8199(), arg4);
			}
			Static1.aSoftwareIndexedSprite42.method8202(arg5, arg4);
			Static608.aSoftwareIndexedSprite41.method8202(arg0 + arg5 - Static608.aSoftwareIndexedSprite41.method8199(), arg4);
		}
