...
public final class Static369 {
		...
		for (@Pc(13) int local13 = 0; local13 < local11; local13++) {
			if (Static363.aByteArrayArray22[local13] != null) {
				...
				while (Static363.aByteArrayArray22[local13].length > local66.pos && local68 < 511 && Static390.anInt6126 < 1023) {
					...
					@Pc(121) int local121 = local104 + (Static89.anIntArray169[local13] >> 8) * 64 - Static691.originX;
					@Pc(135) int local135 = (Static89.anIntArray169[local13] & 0xFF) * 64 + local108 - Static116.originZ;
					...
					if (local149 == null && (local142.aByte103 & 0x1) > 0 && local98 == Static164.anInt2808 && local121 >= 0 && local142.anInt6713 + local121 < Static720.anInt10859 && local135 >= 0 && local135 + local142.anInt6713 < Static501.anInt7568) {
						...
						local197.anInt10751 = Static333.loop;
						local197.method9328(local142);
						local197.method9310(local197.aNpcType1.anInt6713);
						local197.anInt10757 = local197.aNpcType1.lb << 3;
						local197.method9298((local197.aNpcType1.aByte110 + 4 & 0x80600007) << 11, true);
	...
	public static void method3851(@OriginalArg(0) Class19 arg0) {
		if (Static133.aLinkedList13.method7701() == 0) {
			return;
		}
		...
		if (Static400.aClass2_Sub34_28.aPreference_Sub29_1.method7915() == 0) {
			for (local31 = (Linkable_Sub36) Static133.aLinkedList13.head(); local31 != null; local31 = (Linkable_Sub36) Static133.aLinkedList13.next()) {
				ObjTypeList.objTypes.method2478(local31.anInt5893, arg0, arg0, local31.aBoolean451 ? Static556.self.aPlayerAppearance1 : null, false, local31.anInt5891, local31.anInt5888, false, local31.anInt5890, Static665.aClass14_12, local31.anInt5895);
				local31.unlink();
			}
		...
		if (Static158.aClass19_5 == null) {
			...
			Static158.aClass19_5 = Static255.method3612(client.shaders, Static56.anInterface4_3, 0, local85, 0);
			Static629.aClass14_11 = Static158.aClass19_5.method8010(Static74.method1535(Static662.anInt9845, client.fontMetrics), Static735.method9375(client.sprites, Static662.anInt9845), true);
		}
		for (local31 = (Linkable_Sub36) Static133.aLinkedList13.head(); local31 != null; local31 = (Linkable_Sub36) Static133.aLinkedList13.next()) {
			ObjTypeList.objTypes.method2478(local31.anInt5893, Static158.aClass19_5, arg0, local31.aBoolean451 ? Static556.self.aPlayerAppearance1 : null, false, local31.anInt5891, local31.anInt5888, false, local31.anInt5890, Static629.aClass14_11, local31.anInt5895);
			local31.unlink();
		}
	}
