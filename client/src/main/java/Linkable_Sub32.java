...
public final class Linkable_Sub32 extends Linkable {
	...
	private final Linkable_Sub7 aClass2_Sub7_1;
	...
	private HashTable aHashTable25;
	...
	public Linkable_Sub32(@OriginalArg(0) Class19_Sub1 arg0, @OriginalArg(1) Class178_Sub1 arg1, @OriginalArg(2) Linkable_Sub7 arg2, @OriginalArg(3) int[] arg3) {
		...
		if (this.anInt5023 <= 0) {
			...
			while (true) {
				...
				this.aStream3.f(0);
				this.aHashTable25.clear();
			}
		}
		this.aHashTable25 = null;
	...
	private void method4563(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) int arg5) {
		...
		if ((arg4 & 0x7F) == 0 || (arg2 & 0x7F) == 0) {
			...
			@Pc(63) Linkable local63 = this.aHashTable25.get(local7);
			if (local63 != null) {
				this.method4561(((Linkable_Sub50) local63).aShort119);
				return;
			}
		}
		@Pc(82) short local82 = (short) this.anInt5028++;
		if (local7 != -1L) {
			this.aHashTable25.put(local7, new Linkable_Sub50(local82));
		}
