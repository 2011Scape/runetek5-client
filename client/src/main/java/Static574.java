...
public final class Static574 {
	...
	public static BasTypeList aBasTypeList2;
	...
	public static void method7572() {
		if (Static163.aClass19_17.method7978()) {
			Static163.aClass19_17.method7972(Static434.canvas);
			Static208.method3106();
			if (Static137.aBoolean210) {
				Static720.method9397(Static434.canvas);
			} else {
				@Pc(26) Dimension local26 = Static434.canvas.getSize();
				Static163.aClass19_17.method8022(Static434.canvas, local26.width, local26.height);
			}
			Static163.aClass19_17.method8019(Static434.canvas);
		} else {
