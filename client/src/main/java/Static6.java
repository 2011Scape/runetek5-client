...
public final class Static6 {
	...
	public static void method107(@OriginalArg(1) int arg0, @OriginalArg(2) Class1 arg1, @OriginalArg(3) SoftwareIndexedSprite arg2, @OriginalArg(4) int arg3, @OriginalArg(5) int arg4, @OriginalArg(6) Component arg5, @OriginalArg(7) int arg6) {
		...
		@Pc(60) int local60 = Model.anIntArray741[local15];
		@Pc(64) int local64 = Model.anIntArray740[local15];
		if (Static511.cameraType != 4) {
		...
		arg2.method8195(local98 + arg5.width / 2 + arg6 - arg2.method8203() / 2, arg5.height / 2 + arg0 - local109 + -(arg2.method8192() / 2), arg1, arg6, arg0);
	}
}
