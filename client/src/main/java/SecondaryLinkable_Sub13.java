...
public final class SecondaryLinkable_Sub13 extends SecondaryLinkable {
	...
	public final LinkedList aLinkedList26;

	@OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V")
	public SecondaryLinkable_Sub13(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1, @OriginalArg(2) String arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		this.aString48 = arg1;
		this.anInt4561 = arg4;
		this.anInt4556 = arg3;
		this.anInt4564 = arg6;
		...
		this.aLinkedList26 = new LinkedList();
	}
	...
	public boolean method4085(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
		for (@Pc(23) Linkable_Sub56 local23 = (Linkable_Sub56) this.aLinkedList26.head(); local23 != null; local23 = (Linkable_Sub56) this.aLinkedList26.next()) {
	...
	public boolean method4086(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		for (@Pc(17) Linkable_Sub56 local17 = (Linkable_Sub56) this.aLinkedList26.head(); local17 != null; local17 = (Linkable_Sub56) this.aLinkedList26.next()) {
	...
	public boolean method4088(@OriginalArg(1) int[] arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int arg2, @OriginalArg(4) int arg3) {
		for (@Pc(15) Linkable_Sub56 local15 = (Linkable_Sub56) this.aLinkedList26.head(); local15 != null; local15 = (Linkable_Sub56) this.aLinkedList26.next()) {
	...
	public void method4090() {
		...
		this.anInt4552 = 0;
		for (@Pc(28) Linkable_Sub56 local28 = (Linkable_Sub56) this.aLinkedList26.head(); local28 != null; local28 = (Linkable_Sub56) this.aLinkedList26.next()) {
	...
	public boolean method4091(@OriginalArg(0) int arg0, @OriginalArg(2) int arg1, @OriginalArg(3) int[] arg2) {
		for (@Pc(9) Linkable_Sub56 local9 = (Linkable_Sub56) this.aLinkedList26.head(); local9 != null; local9 = (Linkable_Sub56) this.aLinkedList26.next()) {
