...
public final class Model_Sub3 extends Model {
	...
	private Model_Sub3[] aClass114_Sub3Array1;
	...
	private Model_Sub3[] aClass114_Sub3Array2;
	...
	public Model_Sub3(@OriginalArg(0) Class19_Sub2 arg0, @OriginalArg(1) Class88 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		this.aClass19_Sub2_9 = arg0;
		this.anInt8489 = arg2;
		this.anInt8495 = arg3;
		this.anInt8485 = arg4;
				...
				for (@Pc(169) int local169 = 0; local169 < arg1.aClass24Array1.length; local169++) {
					...
					if (local152 == local175.anInt588) {
						...
						if (local184.anInt9693 != -1) {
							@Pc(199) Material local199 = local47.method6817(local184.anInt9693);
	...
	public void a(@OriginalArg(0) int arg0) {
		if ((this.anInt8489 & 0x5) != 5) {
			...
			@Pc(35) int local35 = Model.anIntArray741[arg0];
			@Pc(39) int local39 = Model.anIntArray740[arg0];
			synchronized (this) {
	...
	protected void I(@OriginalArg(0) int arg0, @OriginalArg(1) int[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int[] arg7) {
		...
		if (arg0 == 2) {
			if (arg7 == null) {
					...
					if (local69 < this.anIntArrayArray212.length) {
						...
						for (local337 = 0; local337 < local335.length; local337++) {
							...
							if (this.aShortArray121 == null || (arg6 & this.aShortArray121[local86]) != 0) {
								...
								if (arg4 != 0) {
									local91 = Model.anIntArray741[arg4];
									local506 = Model.anIntArray740[arg4];
								...
								if (arg2 != 0) {
									local91 = Model.anIntArray741[arg2];
									local506 = Model.anIntArray740[arg2];
								...
								if (arg3 != 0) {
									local91 = Model.anIntArray741[arg3];
									local506 = Model.anIntArray740[arg3];
				...
				local531 = Model.anIntArray740[arg2];
				local556 = Model.anIntArray741[arg2];
				local595 = Model.anIntArray740[arg3];
				local599 = Model.anIntArray741[arg3];
				local603 = Model.anIntArray740[arg4];
				local607 = Model.anIntArray741[arg4];
		...
		if (arg0 == 0) {
			...
			if (arg0 == 2) {
				for (local3 = 0; local3 < this.anInt8483; local3++) {
					...
					if (arg3 != 0) {
						local14 = Model.anIntArray741[arg3];
						local168 = Model.anIntArray740[arg3];
					...
					if (arg1 != 0) {
						local14 = Model.anIntArray741[arg1];
						local168 = Model.anIntArray740[arg1];
					...
					if (arg2 != 0) {
						local14 = Model.anIntArray741[arg2];
						local168 = Model.anIntArray740[arg2];
				...
				if (local69 < this.anIntArrayArray212.length) {
					...
					if ((arg5 & 0x1) == 0) {
						for (local244 = 0; local244 < local242.length; local244++) {
							...
							if (arg4 != 0) {
								local91 = Model.anIntArray741[arg4];
								local354 = Model.anIntArray740[arg4];
							...
							if (arg2 != 0) {
								local91 = Model.anIntArray741[arg2];
								local354 = Model.anIntArray740[arg2];
							...
							if (arg3 != 0) {
								local91 = Model.anIntArray741[arg3];
								local354 = Model.anIntArray740[arg3];
	...
	private Model method7514(@OriginalArg(0) Model_Sub3 arg0, @OriginalArg(1) Model_Sub3 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) boolean arg4) {
	...
	public void k(@OriginalArg(0) int arg0) {
		if ((this.anInt8489 & 0xD) != 13) {
			...
			@Pc(40) int local40 = Model.anIntArray741[arg0];
			@Pc(44) int local44 = Model.anIntArray740[arg0];
			synchronized (this) {
				@Pc(67) int local67;
	...
	public void FA(@OriginalArg(0) int arg0) {
		...
		@Pc(14) int local14 = Model.anIntArray741[arg0];
		@Pc(18) int local18 = Model.anIntArray740[arg0];
		synchronized (this) {
	...
	public void aa(@OriginalArg(0) short arg0, @OriginalArg(1) short arg1) {
		...
		if (!this.aBoolean651 && arg1 >= 0) {
			@Pc(20) Material local20 = this.aClass19_Sub2_9.anInterface4_10.method6817(arg1 & 0xFFFF);
	...
	private int method7531(@OriginalArg(0) int arg0, @OriginalArg(1) short arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(15) Material local15 = this.aClass19_Sub2_9.anInterface4_10.method6817(arg1 & 0xFFFF);
