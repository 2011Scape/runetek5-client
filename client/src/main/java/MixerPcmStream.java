...
public final class MixerPcmStream extends PcmStream {
	...
	public synchronized void method5882(@OriginalArg(0) PcmStream arg0) {
		this.aLinkedList35.addHead(arg0);
	}

	@OriginalMember(owner = "client!nn", name = "b", descriptor = "(Lclient!dea;)V")
	public synchronized void method5883(@OriginalArg(0) PcmStream arg0) {
		arg0.unlink();
	}

	@OriginalMember(owner = "client!nn", name = "b", descriptor = "(I)V")
	private void method5884(@OriginalArg(0) int arg0) {
		for (@Pc(5) PcmStream local5 = (PcmStream) this.aLinkedList35.head(); local5 != null; local5 = (PcmStream) this.aLinkedList35.next()) {
	...
	public PcmStream method9135() {
		return (PcmStream) this.aLinkedList35.next();
	}
	...
	public PcmStream method9133() {
		return (PcmStream) this.aLinkedList35.head();
	}
