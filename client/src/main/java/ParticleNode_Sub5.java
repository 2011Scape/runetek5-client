...
public final class ParticleNode_Sub5 extends ParticleNode {
	...
	public final ParticleNode_Sub4_Sub2_Sub1[] aClass8_Sub4_Sub2_Sub1Array1 = new ParticleNode_Sub4_Sub2_Sub1[8192];

	@OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(IZ)V")
	public ParticleNode_Sub5(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1) {
