...
public final class Static639 {
	...
	public static int method8418(@OriginalArg(0) World arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) boolean arg3, @OriginalArg(4) int arg4, @OriginalArg(5) World arg5, @OriginalArg(6) boolean arg6) {
		if (arg4 < 14) {
			method8418((World) null, -49, -123, false, -125, (World) null, true);
		}
