...
public final class Static30 {
	...
	private static HashTable aHashTable28;
	...
	private static ParticleLinkedList[][][] aParticleLinkedListArrayArrayArray2;
	...
	private static final HashTable aHashTable27 = new HashTable(16);
	...
	public static final LinkedList aLinkedList31 = new LinkedList();

	@OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)Lclient!ip;")
	public static Map method5059(@OriginalArg(0) int arg0) {
		return (Map) aHashTable27.get((long) arg0);
	}
		...
		for (@Pc(16) int local16 = -5; local16 < anInt5650; local16++) {
			...
			for (@Pc(27) int local27 = 0; local27 < anInt5644; local27++) {
				...
				if (local21 < anInt5650) {
					...
					if (local41 > 0) {
						local50 = aFluTypeList5.method2066(local41 - 1);
	...
	public static void method5065(@OriginalArg(0) Js5 arg0, @OriginalArg(1) FloTypeList arg1, @OriginalArg(2) FluTypeList arg2, @OriginalArg(3) LocTypeList arg3, @OriginalArg(4) MelTypeList arg4, @OriginalArg(5) MsiTypeList arg5, @OriginalArg(6) Interface23 arg6) {
		...
		if (local28 != null) {
			for (@Pc(32) int local32 = 0; local32 < local28.length; local32++) {
				...
				aHashTable27.put((long) local41.anInt4563, local41);
			}
		}
	...
	private static void method5066(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
				...
				if (local50 >= 0 && local50 < anInt5650) {
						...
						if (local84 > 0) {
							...
							if (local175 == 0 && local177 == 0 && local179 == 0) {
								if (aClass2_Sub2_Sub13_3.anInt4561 != -1) {
									...
									local175 = anIntArray419[aFloTypeList2.anInt2509 + 1];
								} else {
									local175 = -11840664;
								}
								if (local175 == 0) {
								...
								@Pc(282) Linkable_Sub23 local282 = (Linkable_Sub23) aHashTable28.get((long) (local50 << 16 | local93));
								if (local282 != null) {
					...
					for (local57 = 0; local57 < local7; local57++) {
						...
						if (aClass2_Sub2_Sub13_3.anInt4561 != -1) {
							...
							local93 = anIntArray419[aFloTypeList2.anInt2509 + 1];
						} else {
							local93 = -11840664;
						}
						if (local93 == 0) {
						...
						if (local93 > 0) {
							...
							if (local173 >= 0 && local173 < anInt5644) {
								...
								if (local175 <= 0) {
									...
									@Pc(459) Linkable_Sub23 local459 = (Linkable_Sub23) aHashTable28.get((long) (local57 << 16 | local173));
									if (local459 != null) {
		...
		local50 = anInt5647 >> 6;
		local57 = anInt5645 >> 6;
		if (local50 >= aParticleLinkedListArrayArrayArray2[0].length) {
			local50 = aParticleLinkedListArrayArrayArray2[0].length - 1;
		}
		if (local57 >= aParticleLinkedListArrayArrayArray2[0][0].length) {
			local57 = aParticleLinkedListArrayArrayArray2[0][0].length - 1;
		}
		for (local70 = 0; local70 < 3; local70++) {
			...
			for (local80 = local40; local80 <= local50; local80++) {
				for (local84 = local44; local84 <= local57; local84++) {
					@Pc(589) ParticleLinkedList local589 = aParticleLinkedListArrayArrayArray2[local70][local80][local84];
					if (local589 != null) {
						local173 = (local80 + (anInt5655 >> 6)) * 64;
						local175 = (local84 + (anInt5648 >> 6)) * 64;
						for (@Pc(612) ParticleNode_Sub10 local612 = (ParticleNode_Sub10) local589.method2790(); local612 != null; local612 = (ParticleNode_Sub10) local589.method2785()) {
			...
			for (local84 = local40; local84 <= local50; local84++) {
				for (local93 = local44; local93 <= local57; local93++) {
					@Pc(727) ParticleLinkedList local727 = aParticleLinkedListArrayArrayArray2[local70][local84][local93];
					if (local727 != null) {
						local175 = (local84 + (anInt5655 >> 6)) * 64;
						local177 = (local93 + (anInt5648 >> 6)) * 64;
						for (@Pc(750) ParticleNode_Sub10 local750 = (ParticleNode_Sub10) local727.method2790(); local750 != null; local750 = (ParticleNode_Sub10) local727.method2785()) {
	...
	public static void method5067(@OriginalArg(0) Interface4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(1) int local1 = 0; local1 < aFloTypeList2.anInt2506; local1++) {
	...
	private static int method5068(@OriginalArg(0) Interface4 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		@Pc(4) FloType local4 = aFloTypeList2.method2352(arg1);
		if (local4 == null) {
			return 0;
		}
	...
	public static void method5069() {
		...
		aHashTable28 = new HashTable(1024);
		aParticleLinkedListArrayArrayArray2 = new ParticleLinkedList[3][anInt5650 >> 6][anInt5644 >> 6];
		anIntArray419 = new int[aFloTypeList2.anInt2506 + 1];
	}
	...
	public static void method5070() {
		...
		aByteArray58 = null;
		aHashTable28 = null;
		aParticleLinkedListArrayArrayArray2 = null;
		anIntArray419 = null;
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;Lclient!fu;Lclient!el;)V")
	public static void method5071(@OriginalArg(0) Class19 arg0, @OriginalArg(1) MapElement arg1, @OriginalArg(2) MelType arg2) {
	...
	public static void method5072(@OriginalArg(0) int arg0) {
		aClass2_Sub2_Sub13_3 = (Map) aHashTable27.get((long) arg0);
	}

	@OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lclient!ha;Lclient!fu;IIII)V")
	private static void method5073(@OriginalArg(0) Class19 arg0, @OriginalArg(1) MapElement arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
	...
	private static void method5074(@OriginalArg(0) Class19 arg0, @OriginalArg(1) Packet arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int[] arg6, @OriginalArg(7) int[] arg7) {
		...
		for (@Pc(118) int local118 = 0; local118 < local100; local118++) {
			...
			if (local118 == 0) {
				...
				if (local139 == 1) {
					...
					aHashTable28.put((long) (arg4 << 16 | arg5), new Linkable_Sub23(local215, local218));
				}
			} else {
				local215 = null;
				local218 = null;
				...
				if (aParticleLinkedListArrayArrayArray2[local118 - 1][arg2 - (anInt5655 >> 6)][arg3 - (anInt5648 >> 6)] == null) {
					aParticleLinkedListArrayArrayArray2[local118 - 1][arg2 - (anInt5655 >> 6)][arg3 - (anInt5648 >> 6)] = new ParticleLinkedList();
				}
				@Pc(338) ParticleNode_Sub10 local338 = new ParticleNode_Sub10(arg4 & 0x3F, arg5 & 0x3F, local123, local125, local127, local215, local218);
				aParticleLinkedListArrayArrayArray2[local118 - 1][arg2 - (anInt5655 >> 6)][arg3 - (anInt5648 >> 6)].method2787(local338);
			}
		}
	}
	...
	private static void method5075() {
				...
				if (local15 != 0) {
					...
					if (local15 == 65535) {
						...
						if (local35 != -1) {
							...
							aLinkedList31.addTail(local118);
						}
					}
				}
			}
		...
		for (local4 = 0; local4 < 3; local4++) {
			for (local15 = 0; local15 < aParticleLinkedListArrayArrayArray2[0].length; local15++) {
				for (@Pc(144) int local144 = 0; local144 < aParticleLinkedListArrayArrayArray2[0][0].length; local144++) {
					@Pc(153) ParticleLinkedList local153 = aParticleLinkedListArrayArrayArray2[local4][local15][local144];
					if (local153 != null) {
							...
							if (local160.aShortArray133 != null) {
								for (local49 = 0; local49 < local160.aShortArray133.length; local49++) {
									...
									if (local180 != -1) {
										...
										aLinkedList31.addTail(local201);
									}
								}
							}
						}
	...
	public static SecondaryLinkedList method5076(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(3) SecondaryLinkedList local3 = new SecondaryLinkedList();
		for (@Pc(8) Map local8 = (Map) aHashTable27.head(); local8 != null; local8 = (Map) aHashTable27.next()) {
	...
	public static Map method5078(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		for (@Pc(4) Map local4 = (Map) aHashTable27.head(); local4 != null; local4 = (Map) aHashTable27.next()) {
	...
	public static void method5079() {
		...
		for (@Pc(4) int local4 = 0; local4 < aClass255_3.anInt6373; local4++) {
			...
			if (local32) {
				@Pc(42) MapElement local42 = new MapElement(aClass255_3.anIntArray496[local4]);
				local42.anInt3129 = local2[1] - anInt5655;
				local42.anInt3124 = local2[2] - anInt5648;
				aLinkedList31.addTail(local42);
			}
		}
	}
	...
	public static void method5080(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		while (true) {
			...
			for (local60 = 0; local60 < 3; local60++) {
				...
				for (local66 = 0; local66 < aParticleLinkedListArrayArrayArray2[local60].length; local66++) {
					for (local69 = 0; local69 < aParticleLinkedListArrayArrayArray2[local60][0].length; local69++) {
						@Pc(207) ParticleLinkedList local207 = aParticleLinkedListArrayArrayArray2[local60][local66][local69];
						if (local207 != null) {
							for (@Pc(214) ParticleNode_Sub10 local214 = (ParticleNode_Sub10) local207.method2790(); local214 != null; local214 = (ParticleNode_Sub10) local207.method2785()) {
				...
				for (local69 = 0; local69 < aParticleLinkedListArrayArrayArray2[local60].length; local69++) {
					for (local78 = 0; local78 < aParticleLinkedListArrayArrayArray2[local60][0].length; local78++) {
						@Pc(278) ParticleLinkedList local278 = aParticleLinkedListArrayArrayArray2[local60][local69][local78];
						if (local278 != null) {
							for (@Pc(285) ParticleNode_Sub10 local285 = (ParticleNode_Sub10) local278.method2790(); local285 != null; local285 = (ParticleNode_Sub10) local278.method2785()) {
	...
	public static LinkedList method5081(@OriginalArg(0) Class19 arg0) {
		@Pc(3) int local3 = anInt5647 - anInt5652;
		@Pc(7) int local7 = anInt5645 - anInt5654;
		@Pc(15) int local15 = (anInt5651 - anInt5649 << 16) / local3;
		@Pc(23) int local23 = (anInt5646 - anInt5653 << 16) / local7;
	...
	private static LinkedList method5082(@OriginalArg(0) Class19 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		for (@Pc(4) MapElement local4 = (MapElement) aLinkedList31.head(); local4 != null; local4 = (MapElement) aLinkedList31.next()) {
			method5073(arg0, local4, arg1, arg2);
		}
		return aLinkedList31;
	}
}
