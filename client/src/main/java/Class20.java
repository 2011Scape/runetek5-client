...
public final class Class20 {
	...
	private void method585(@OriginalArg(0) Packet arg0) {
		...
		for (@Pc(28) int local28 = arg0.g1(); local28 != 0; local28 = arg0.g1()) {
			...
			@Pc(61) Linkable_Sub14 local61;
			if (local28 == 3) {
				local61 = new Linkable_Sub14_Sub4();
			} else if (local28 == 1) {
				local61 = new Linkable_Sub14_Sub2();
			} else if (local28 == 13) {
				local61 = new Linkable_Sub14_Sub7();
			} else if (local28 == 4) {
				local61 = new Linkable_Sub14_Sub6();
			} else if (local28 == 6) {
				local61 = new Linkable_Sub14_Sub13();
			} else if (local28 == 5) {
				local61 = new Linkable_Sub14_Sub8();
			} else if (local28 == 2) {
				local61 = new Linkable_Sub14_Sub5();
			} else if (local28 == 7) {
				local61 = new Linkable_Sub14_Sub10();
			} else if (local28 == 8) {
				local61 = new Linkable_Sub14_Sub11();
			} else if (local28 == 9) {
				local61 = new Linkable_Sub14_Sub1();
			} else if (local28 == 10) {
				local61 = new Linkable_Sub14_Sub12();
			} else if (local28 == 11) {
				local61 = new Linkable_Sub14_Sub9();
			} else if (local28 == 12) {
				local61 = new Linkable_Sub14_Sub3();
			} else {
	...
	public void method587(@OriginalArg(1) Class164 arg0) {
		...
		for (@Pc(82) Linkable_Sub14 local82 = (Linkable_Sub14) this.aLinkedList4.head(); local82 != null; local82 = (Linkable_Sub14) this.aLinkedList4.next()) {
