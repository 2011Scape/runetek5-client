...
public final class Static251 {
	...
	public static boolean method3549(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		...
		if (Static453.components[local12] == null || Static453.components[local12][local23] == null) {
			return false;
		}
		@Pc(44) Component local44 = Static453.components[local12][local23];
		...
		if (arg1 == -1 && local44.type == 0) {
			for (local57 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.head(); local57 != null; local57 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.next()) {
				if (local57.anInt7314 == 18 || local57.anInt7314 == 1002 || local57.anInt7314 == 12 || local57.anInt7314 == 20 || local57.anInt7314 == 10) {
					for (@Pc(160) Component local160 = Static145.getComponent(local57.anInt7313); local160 != null; local160 = Static556.method7299(local160)) {
						if (local160.id == local44.id) {
							return true;
						}
					}
				}
			...
			for (local57 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.head(); local57 != null; local57 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.next()) {
				if (local57.anInt7316 == arg1 && local44.id == local57.anInt7313 && (local57.anInt7314 == 18 || local57.anInt7314 == 1002 || local57.anInt7314 == 12 || local57.anInt7314 == 20 || local57.anInt7314 == 10)) {
					return true;
				}
			}
		}
