...
public final class VorbisSound extends Linkable {
	...
	private float[] method8503(@OriginalArg(0) int arg0) {
		...
		@Pc(123) VorbisMapping local123 = Static650.aVorbisMappingArray1[Static650.anIntArray756[local15]];
		@Pc(126) int local126 = local123.anInt9478;
		@Pc(131) int local131 = local123.anIntArray738[local126];
		@Pc(140) boolean local140 = !Static650.aVorbisFloorArray1[local131].method1089();
		@Pc(154) float[] local154;
		for (@Pc(144) int local144 = 0; local144 < local123.anInt9477; local144++) {
			@Pc(152) VorbisResidue local152 = Static650.aVorbisResidueArray1[local123.anIntArray739[local144]];
		...
		if (!local140) {
			...
			Static650.aVorbisFloorArray1[local176].method1086(Static650.aFloatArray73, local25 >> 1);
		}
		@Pc(212) int local212;
		if (local140) {
