...
public final class Linkable_Sub7_Sub3 extends Linkable_Sub7 {

	@OriginalMember(owner = "client!uda", name = "<init>", descriptor = "(IIIIIF)V")
	public Linkable_Sub7_Sub3(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) float arg5) {
