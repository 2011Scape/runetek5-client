...
public final class Static694 {
	...
	public static byte[] method9027(@OriginalArg(0) int arg0) {
		@Pc(17) ByteArraySecondaryNode local17 = (ByteArraySecondaryNode) Static541.aLruHashTable4.get((long) arg0);
		if (local17 == null) {
			...
			Static541.aLruHashTable4.method8341((long) arg0, local17);
		}
