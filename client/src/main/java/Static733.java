...
public final class Static733 {
	...
	public static Class19 method7618(@OriginalArg(0) Js5 arg0, @OriginalArg(1) int arg1, @OriginalArg(3) Interface4 arg2, @OriginalArg(4) Canvas arg3) {
		try {
			if (!Static651.method8516()) {
				throw new RuntimeException("");
			} else if (Static14.method179("jagdx")) {
				@Pc(26) Class local26 = Class.forName("Class19_Sub1_Sub1");
				@Pc(68) Method local68 = local26.getDeclaredMethod("createToolkit", Class.forName("java.awt.Canvas"), Class.forName("Interface4"), Class.forName("Js5"), Class.forName("java.lang.Integer"));
