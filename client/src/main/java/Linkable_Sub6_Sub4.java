...
public final class Linkable_Sub6_Sub4 extends Linkable_Sub6 {

	@OriginalMember(owner = "client!uka", name = "t", descriptor = "Lclient!sia;")
	public final LinkedList aLinkedList72 = new LinkedList();

	@OriginalMember(owner = "client!uka", name = "A", descriptor = "Lclient!nn;")
	public final Linkable_Sub6_Sub3 aClass2_Sub6_Sub3_2 = new Linkable_Sub6_Sub3();

	@OriginalMember(owner = "client!uka", name = "D", descriptor = "Lclient!bd;")
	private final Linkable_Sub6_Sub1 aClass2_Sub6_Sub1_4;

	@OriginalMember(owner = "client!uka", name = "<init>", descriptor = "(Lclient!bd;)V")
	public Linkable_Sub6_Sub4(@OriginalArg(0) Linkable_Sub6_Sub1 arg0) {
	...
	public void method9130(@OriginalArg(0) int arg0) {
		...
		for (@Pc(15) Linkable_Sub16 local15 = (Linkable_Sub16) this.aLinkedList72.head(); local15 != null; local15 = (Linkable_Sub16) this.aLinkedList72.next()) {
	...
	public Linkable_Sub6 method9135() {
		@Pc(11) Linkable_Sub16 local11;
		do {
			local11 = (Linkable_Sub16) this.aLinkedList72.next();
			if (local11 == null) {
				return null;
			}
	...
	public Linkable_Sub6 method9133() {
		@Pc(9) Linkable_Sub16 local9 = (Linkable_Sub16) this.aLinkedList72.head();
		if (local9 == null) {
			return null;
	...
	private void method8535(@OriginalArg(0) int[] arg0, @OriginalArg(1) Linkable_Sub16 arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
		if ((this.aClass2_Sub6_Sub1_4.anIntArray56[arg1.anInt2187] & 0x4) != 0 && arg1.anInt2202 < 0) {
			...
			while (true) {
				...
				@Pc(91) Linkable_Sub6_Sub2 local91 = arg1.aClass2_Sub6_Sub2_1;
	...
	public void method9131(@OriginalArg(0) int[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		for (@Pc(17) Linkable_Sub16 local17 = (Linkable_Sub16) this.aLinkedList72.head(); local17 != null; local17 = (Linkable_Sub16) this.aLinkedList72.next()) {
