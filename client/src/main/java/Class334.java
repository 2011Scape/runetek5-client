...
public final class Class334 {
	...
	public Interface18 method7654(@OriginalArg(1) int arg0) {
		...
		if (local12 != null) {
			...
			this.aSoftLruHashTable187.put((long) arg0, local105);
			return local105;
		} else {
			return null;
		}
	...
	public void method7655() {
		this.aSoftLruHashTable187.clean(5);
	}
}
