...
public final class Static159 {
	...
	public static LinkedList aLinkedList15 = new LinkedList();
	...
	public static void method2574(@OriginalArg(0) Class19 arg0) {
		...
		if (Static236.aBoolean304) {
			local80 = 0;
			for (@Pc(137) SecondaryLinkable_Sub4 local137 = (SecondaryLinkable_Sub4) Static350.aSecondaryLinkedList8.head(); local137 != null; local137 = (SecondaryLinkable_Sub4) Static350.aSecondaryLinkedList8.next()) {
				local101 = local9 + Static84.anInt1775 + local80 * 16 + 31;
				if (local137.anInt1534 == 1) {
					Static232.method3387(arg0, Static682.anInt10295, Static407.anInt6288, Static84.anInt1775 + local9, local101, -256, (SecondaryLinkable_Sub16) local137.aSecondaryLinkedList3.sentinel.secondaryPrev, -1, local76, local7 + Static71.anInt1576, local69);
				} else {
			...
			if (Static139.aClass2_Sub2_Sub4_1 != null) {
				...
				for (@Pc(239) SecondaryLinkable_Sub16 local239 = (SecondaryLinkable_Sub16) Static139.aClass2_Sub2_Sub4_1.aSecondaryLinkedList3.head(); local239 != null; local239 = (SecondaryLinkable_Sub16) Static139.aClass2_Sub2_Sub4_1.aSecondaryLinkedList3.next()) {
			...
			local80 = 0;
			for (@Pc(85) SecondaryLinkable_Sub16 local85 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.head(); local85 != null; local85 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.next()) {
