...
public final class Linkable_Sub1_Sub32 extends Linkable_Sub1 {
	...
	public int[] method9411(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (super.aClass180_41.aBoolean338) {
			...
			for (@Pc(50) int local50 = 0; local50 < Static608.anInt9289; local50++) {
				...
				@Pc(133) int local133 = Linkable_Sub28.aByteArray103[local90 + ((local99 + 1) * local99 >> 1)] & 0xFF;
