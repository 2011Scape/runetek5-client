...
public final class Static658 {
	...
	public static final HashTable aHashTable43 = new HashTable(16);
	...
	public static void method8591(@OriginalArg(0) ParticleNode_Sub2 arg0, @OriginalArg(1) Linkable_Sub7[] arg1) {
		@Pc(6) int local6;
		...
		if (Static693.aClass178Array2 == Static246.aClass178Array1) {
			...
			if (arg0 instanceof Entity) {
				...
				local6 = arg0.xFine >> Static52.anInt1066;
				local28 = arg0.zFine >> Static52.anInt1066;
			}
			Static665.aClass19_15.EA(Static706.aClass178Array3[0].method7878(arg0.zFine, arg0.xFine), Static100.method1987(local6, local28), Static350.method5124(local6, local28), Static339.method5005(local6, local28));
		}
		@Pc(64) ParticleNode_Sub7 local64 = arg0.method9276(Static665.aClass19_15);
		if (local64 == null) {
			return;
		}
		if (arg0.aBoolean813) {
			@Pc(74) ParticleNode_Sub6[] local74 = local64.aClass8_Sub6Array1;
			for (@Pc(76) int local76 = 0; local76 < local74.length; local76++) {
				@Pc(81) ParticleNode_Sub6 local81 = local74[local76];
