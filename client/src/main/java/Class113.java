...
public final class Class113 {
	...
	private SecondaryParticleNode aClass8_Sub4_2;

	@OriginalMember(owner = "client!et", name = "e", descriptor = "Lclient!fi;")
	public final SecondaryParticleNode aClass8_Sub4_1 = new SecondaryParticleNode();
	...
	public void method2487() {
		while (true) {
			@Pc(16) SecondaryParticleNode local16 = this.aClass8_Sub4_1.aClass8_Sub4_10;
	...
	public void method2488(@OriginalArg(1) SecondaryParticleNode arg0) {
	...
	public int method2489() {
		@Pc(7) int local7 = 0;
		for (@Pc(19) SecondaryParticleNode local19 = this.aClass8_Sub4_1.aClass8_Sub4_10; local19 != this.aClass8_Sub4_1; local19 = local19.aClass8_Sub4_10) {
			local7++;
		}
		return local7;
	}
	...
	public SecondaryParticleNode method2490() {
		@Pc(6) SecondaryParticleNode local6 = this.aClass8_Sub4_2;
	...
	public SecondaryParticleNode method2491() {
		@Pc(15) SecondaryParticleNode local15 = this.aClass8_Sub4_1.aClass8_Sub4_10;
