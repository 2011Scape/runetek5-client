...
public final class Static110 {
	...
	public static void method2079(@OriginalArg(0) int arg0) {
		@Pc(7) int local7 = Static333.loop - Static212.anInt3468;
		if (local7 >= 100) {
		...
		Static292.method4606(local28, (local28 >> 3) * 3 + 600 << 2, arg0, Static494.anInt7409, local63, Static38.anInt920, Static102.method2025(Static394.anInt6176, -29754, Static556.self.zFine, Static556.self.xFine) - 200);
		...
		@Pc(160) int local160 = Static323.cameraYaw - Static225.anInt3641;
		if (local160 > 8192) {
			local160 -= 16384;
		} else if (local160 < -8192) {
			local160 += 16384;
		}
		Static323.cameraYaw = (int) ((float) Static225.anInt3641 + (float) local160 * local107);
