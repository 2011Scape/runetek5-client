...
public final class Static321 {
	...
	public static final ClientProt aClientProt64 = new ClientProt(58, 2);
	...
	public static boolean method4622(@OriginalArg(0) int arg0) {
		for (@Pc(8) SecondaryLinkable_Sub16 local8 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.head(); local8 != null; local8 = (SecondaryLinkable_Sub16) Static693.aLinkedList79.next()) {
