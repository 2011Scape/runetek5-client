...
public final class ParticleNode_Sub2_Sub1_Sub2_Sub1 extends ParticleNode_Sub2_Sub1_Sub2 {
	...
	public ParticleNode_Sub2_Sub1_Sub2_Sub1(@OriginalArg(0) int arg0) {
		super(arg0);
	}

	@OriginalMember(owner = "client!ca", name = "<init>", descriptor = "()V")
	public ParticleNode_Sub2_Sub1_Sub2_Sub1() {
	}
			...
			for (local269 = Static527.aClass254Array1.length - 1; local269 >= 0; local269--) {
				...
				if (local275 != null && local275.anInt6371 != -1) {
					...
					if (local275.anInt6363 == 1) {
						...
						if (local298 != null) {
							@Pc(303) ParticleNode_Sub2_Sub1_Sub2_Sub2 local303 = local298.aClass8_Sub2_Sub1_Sub2_Sub2_2;
					...
					if (local275.anInt6363 == 10 && local275.anInt6366 >= 0 && local275.anInt6366 < Static621.aClass8_Sub2_Sub1_Sub2_Sub1Array3.length) {
						@Pc(438) ParticleNode_Sub2_Sub1_Sub2_Sub1 local438 = Static621.aClass8_Sub2_Sub1_Sub2_Sub1Array3[local275.anInt6366];
						if (local438 != null) {
